...
abstract class BaseRoleForm extends BaseFormPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'charge_havingregardto'       => new sfWidgetFormTextarea(),
      'confirmation_havingregardto' => new sfWidgetFormTextarea(),
    ...
    $this->setValidators(array(
      ...
      'charge_havingregardto'       => new sfValidatorString(array('required' => false)),
      'confirmation_havingregardto' => new sfValidatorString(array('required' => false)),
