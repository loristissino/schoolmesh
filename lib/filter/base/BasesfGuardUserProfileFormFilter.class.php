...
class BasesfGuardUserProfileFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'googleapps_account_lastlogin_at'       => new sfWidgetFormFilterDate(array('from_date' => new sfWidgetFormDate(), 'to_date' => new sfWidgetFormDate(), 'with_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'googleapps_account_lastlogin_at'       => new sfValidatorDateRange(array('required' => false, 'from_date' => new sfValidatorDate(array('required' => false)), 'to_date' => new sfValidatorDate(array('required' => false)))),
  ...
  public function getFields()
  {
    return array(
      ...
      'googleapps_account_lastlogin_at'       => 'Date',
