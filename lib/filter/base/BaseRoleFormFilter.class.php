...
abstract class BaseRoleFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'forfait_retribution'         => new sfWidgetFormFilterInput(),
      'charge_notes'                => new sfWidgetFormFilterInput(),
      'confirmation_notes'          => new sfWidgetFormFilterInput(),
      'charge_havingregardto'       => new sfWidgetFormFilterInput(),
      'confirmation_havingregardto' => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'forfait_retribution'         => new sfValidatorSchemaFilter('text', new sfValidatorNumber(array('required' => false))),
      'charge_notes'                => new sfValidatorPass(array('required' => false)),
      'confirmation_notes'          => new sfValidatorPass(array('required' => false)),
      'charge_havingregardto'       => new sfValidatorPass(array('required' => false)),
      'confirmation_havingregardto' => new sfValidatorPass(array('required' => false)),
