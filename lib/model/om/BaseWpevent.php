...
/**
 * Base class that represents a row from the 'wpevent' table.
 *
 * 
 *
...
abstract class BaseWpevent extends BaseObject  implements Persistent {
	 ...
	 * @return     Wpevent The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 6; // 6 = WpeventPeer::NUM_COLUMNS - WpeventPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($isInsert) {
				...
				// symfony_timestampable behavior
				if (!$this->isColumnModified(WpeventPeer::CREATED_AT))
				{
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Wpevent (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Wpevent Clone of current object.
	 * @throws     PropelException
	 */
	...
	public function getAppointment(PropelPDO $con = null)
	{
		if ($this->aAppointment === null && ($this->appointment_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aAppointment->addWpevents($this);
			 */
		}
	...
	public function getsfGuardUser(PropelPDO $con = null)
	{
		if ($this->asfGuardUser === null && ($this->user_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->asfGuardUser->addWpevents($this);
			 */
		}
