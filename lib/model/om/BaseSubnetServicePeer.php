...
/**
 * Base static class for performing query and update operations on the 'subnet_service' table.
 *
 * 
 *
...
abstract class BaseSubnetServicePeer {
	...
	const OM_CLASS = 'SubnetService';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'lib.model.SubnetService';

	/** the related TableMap class for this table */
	const TM_CLASS = 'SubnetServiceTableMap';
	...
	/**
	 * An identiy map to hold any loaded instances of SubnetService objects.
	 * This must be public so that other peer classes can access this when hydrating from JOIN
	 * queries.
	 * @var        array SubnetService[]
	 */
	 ...
	 * @param      string $column The column name for current table. (i.e. SubnetServicePeer::COLUMN_NAME).
	 * @return     string
	 */
	 ...
	 *
	 * @param      SubnetService $value A SubnetService object.
	 ...
	 *
	 * @param      mixed $value A SubnetService object or a primary key value.
	 */
	 ...
	 * @return     SubnetService Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	/**
	 * Method to invalidate the instance pool of all tables related to subnet_service
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = SubnetServicePeer::getOMClass(false);
	...
	/**
	 * Returns the number of rows matching criteria, joining the related Subnet table
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
	 * @param      PropelPDO $con
	...
	public static function doCountJoinSubnet(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(SubnetServicePeer::SUBNET_ID, SubnetPeer::ID, $join_behavior);
	...
	public static function doCountJoinService(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(SubnetServicePeer::SERVICE_ID, ServicePeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of SubnetService objects pre-filled with their Subnet objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of SubnetService objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinSubnet(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (SubnetService) to $obj2 (Subnet)
	...
	/**
	 * Selects a collection of SubnetService objects pre-filled with their Service objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of SubnetService objects.
	...
	public static function doSelectJoinService(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (SubnetService) to $obj2 (Service)
				$obj2->addSubnetService($obj1);
	...
	/**
	 * Selects a collection of SubnetService objects pre-filled with all related objects.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			// Add objects for joined Subnet rows
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (SubnetService) to the collection in $obj2 (Subnet)
				$obj2->addSubnetService($obj1);
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (SubnetService) to the collection in $obj3 (Service)
	...
	/**
	 * Selects a collection of SubnetService objects pre-filled with all related objects except Subnet.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinAllExceptSubnet(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = SubnetServicePeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (SubnetService) to the collection in $obj2 (Service)
				$obj2->addSubnetService($obj1);
	...
	/**
	 * Selects a collection of SubnetService objects pre-filled with all related objects except Service.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	{
	  $dbMap = Propel::getDatabaseMap(BaseSubnetServicePeer::DATABASE_NAME);
	  if (!$dbMap->hasTable(BaseSubnetServicePeer::TABLE_NAME))
	  {
	    $dbMap->addTableObject(new SubnetServiceTableMap());
	  }
	}
	...
	{
		return $withPrefix ? SubnetServicePeer::CLASS_DEFAULT : SubnetServicePeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a SubnetService or Criteria object.
	 *
	 * @param      mixed $values Criteria or SubnetService object containing data that is used to create the INSERT statement.
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from SubnetService object
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a SubnetService or Criteria object.
	 *
	 * @param      mixed $values Criteria or SubnetService object containing data that is used to create the UPDATE statement.
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		} else { // $values is SubnetService object
	...
	/**
	 * Method to DELETE all rows from the subnet_service table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			SubnetServicePeer::clearRelatedInstancePool();
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
	...
	/**
	 * Method perform a DELETE on the database, given a SubnetService or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or SubnetService object or primary key or array of primary keys
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof SubnetService) { // it's a model object
	...
	/**
	 * Validates all modified columns of given SubnetService object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      SubnetService $obj The object to validate.
	...
	public static function doValidate(SubnetService $obj, $cols = null)
	{
		...
		return BasePeer::doValidate(SubnetServicePeer::DATABASE_NAME, SubnetServicePeer::TABLE_NAME, $columns);
	}
...
} // BaseSubnetServicePeer

// This is the static code needed to register the TableMap for this table with the main Propel class.
//
BaseSubnetServicePeer::buildTableMap();
