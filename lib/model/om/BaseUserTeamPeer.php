...
abstract class BaseUserTeamPeer {
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new UserTeamMapBuilder();
		}
	...
	public static function doCountJoinsfGuardUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(UserTeamPeer::USER_ID,), array(sfGuardUserPeer::ID,), $join_behavior);
	...
	public static function doCountJoinTeam(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(UserTeamPeer::TEAM_ID,), array(TeamPeer::ID,), $join_behavior);
	...
	public static function doCountJoinRole(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(UserTeamPeer::ROLE_ID,), array(RolePeer::ID,), $join_behavior);
	...
	public static function doSelectJoinsfGuardUser(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		UserTeamPeer::addSelectColumns($c);
		$startcol = (UserTeamPeer::NUM_COLUMNS - UserTeamPeer::NUM_LAZY_LOAD_COLUMNS);
		sfGuardUserPeer::addSelectColumns($c);

		$c->addJoin(array(UserTeamPeer::USER_ID,), array(sfGuardUserPeer::ID,), $join_behavior);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = UserTeamPeer::getInstanceFromPool($key1))) {
				...
				$omClass = UserTeamPeer::getOMClass();
	...
	public static function doSelectJoinTeam(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$c = clone $c;
		...
		$c->addJoin(array(UserTeamPeer::TEAM_ID,), array(TeamPeer::ID,), $join_behavior);
		$stmt = BasePeer::doSelect($c, $con);
		$results = array();
	...
	public static function doSelectJoinRole(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$c->addJoin(array(UserTeamPeer::ROLE_ID,), array(RolePeer::ID,), $join_behavior);
		$stmt = BasePeer::doSelect($c, $con);
		$results = array();
	...
	public static function doSelectJoinAllExceptTeam(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$c = clone $c;
  ...
  static public function getUniqueColumnNames()
  {
	...
	{
		return UserTeamPeer::CLASS_DEFAULT;
	}
	...
	public static function doValidate(UserTeam $obj, $cols = null)
	{
		...
		$res =  BasePeer::doValidate(UserTeamPeer::DATABASE_NAME, UserTeamPeer::TABLE_NAME, $columns);
    if ($res !== true) {
        $request = sfContext::getInstance()->getRequest();
        foreach ($res as $failed) {
            $col = UserTeamPeer::translateFieldname($failed->getColumn(), BasePeer::TYPE_COLNAME, BasePeer::TYPE_PHPNAME);
        }
    }
...
Propel::getDatabaseMap(BaseUserTeamPeer::DATABASE_NAME)->addTableBuilder(BaseUserTeamPeer::TABLE_NAME, BaseUserTeamPeer::getMapBuilder());
