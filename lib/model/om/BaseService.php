...
abstract class BaseService extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the is_enabled_by_default field.
	...
	/**
	 * The value for the is_udp field.
	 * Note: this column has a database default value of: false
	 * @var        boolean
	 */
	protected $is_udp;
	...
	/**
	 * Get the [is_enabled_by_default] column value.
	 * 
	 * @return     boolean
	 */
	...
	/**
	 * Set the value of [is_enabled_by_default] column.
	 * 
	...
	public function setIsEnabledByDefault($v)
	{
		...
		if ($this->is_enabled_by_default !== $v || $this->isNew()) {
	...
	/**
	 * Set the value of [is_udp] column.
	 * 
	 * @param      boolean $v new value
	 * @return     Service The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 5; // 5 = ServicePeer::NUM_COLUMNS - ServicePeer::NUM_LAZY_LOAD_COLUMNS).
	 ...
	 * related WorkstationServices from storage. If this Service is new, it will return
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Service has previously been saved, it will retrieve
	 * related SubnetServices from storage. If this Service is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
