...
/**
 * Base static class for performing query and update operations on the 'wpevent' table.
 *
 * 
 *
...
abstract class BaseWpeventPeer {
	...
	/**
	 * An identiy map to hold any loaded instances of Wpevent objects.
	 ...
	 * @param      string $column The column name for current table. (i.e. WpeventPeer::COLUMN_NAME).
	 * @return     string
	 */
	 ...
	 *
	 * @param      Wpevent $value A Wpevent object.
	 ...
	 *
	 * @param      mixed $value A Wpevent object or a primary key value.
	 */
	 ...
	 * @return     Wpevent Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	/**
	 * Method to invalidate the instance pool of all tables related to wpevent
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = WpeventPeer::getOMClass(false);
	...
	public static function doCountJoinAppointment(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(WpeventPeer::APPOINTMENT_ID, AppointmentPeer::ID, $join_behavior);
	...
	public static function doCountJoinsfGuardUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(WpeventPeer::USER_ID, sfGuardUserPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Wpevent objects pre-filled with their Appointment objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of Wpevent objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinAppointment(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Wpevent) to $obj2 (Appointment)
	...
	/**
	 * Selects a collection of Wpevent objects pre-filled with their sfGuardUser objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of Wpevent objects.
	...
	public static function doSelectJoinsfGuardUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Wpevent) to $obj2 (sfGuardUser)
				$obj2->addWpevent($obj1);
	...
	/**
	 * Selects a collection of Wpevent objects pre-filled with all related objects.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Wpevent) to the collection in $obj2 (Appointment)
				$obj2->addWpevent($obj1);
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (Wpevent) to the collection in $obj3 (sfGuardUser)
	...
	/**
	 * Selects a collection of Wpevent objects pre-filled with all related objects except Appointment.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAllExceptAppointment(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = WpeventPeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (Wpevent) to the collection in $obj2 (sfGuardUser)
				$obj2->addWpevent($obj1);
	...
	/**
	 * Selects a collection of Wpevent objects pre-filled with all related objects except sfGuardUser.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	{
	  $dbMap = Propel::getDatabaseMap(BaseWpeventPeer::DATABASE_NAME);
	  if (!$dbMap->hasTable(BaseWpeventPeer::TABLE_NAME))
	  {
	    $dbMap->addTableObject(new WpeventTableMap());
	  }
	}
	...
	{
		return $withPrefix ? WpeventPeer::CLASS_DEFAULT : WpeventPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a Wpevent or Criteria object.
	 *
	 * @param      mixed $values Criteria or Wpevent object containing data that is used to create the INSERT statement.
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from Wpevent object
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a Wpevent or Criteria object.
	 *
	 * @param      mixed $values Criteria or Wpevent object containing data that is used to create the UPDATE statement.
	...
	/**
	 * Method to DELETE all rows from the wpevent table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			WpeventPeer::clearRelatedInstancePool();
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
	...
	/**
	 * Method perform a DELETE on the database, given a Wpevent or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or Wpevent object or primary key or array of primary keys
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof Wpevent) { // it's a model object
	...
	/**
	 * Validates all modified columns of given Wpevent object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      Wpevent $obj The object to validate.
	...
	public static function doValidate(Wpevent $obj, $cols = null)
	{
		...
		return BasePeer::doValidate(WpeventPeer::DATABASE_NAME, WpeventPeer::TABLE_NAME, $columns);
	}
