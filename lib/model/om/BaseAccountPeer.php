...
abstract class BaseAccountPeer {
	...
	/** the column name for the TEMPORARY_PASSWORD field */
	const TEMPORARY_PASSWORD = 'account.TEMPORARY_PASSWORD';

	/** the column name for the INFO_UPDATED_AT field */
	const INFO_UPDATED_AT = 'account.INFO_UPDATED_AT';

	/** the column name for the LAST_KNOWN_LOGIN_AT field */
	const LAST_KNOWN_LOGIN_AT = 'account.LAST_KNOWN_LOGIN_AT';

	/** the column name for the QUOTA_PERCENTAGE field */
	...
	public static function doCountJoinsfGuardUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(AccountPeer::USER_ID, sfGuardUserPeer::ID, $join_behavior);
	...
	/**
	 * Returns the number of rows matching criteria, joining the related AccountType table
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
	 * @param      PropelPDO $con
	...
	public static function doCountJoinAccountType(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(AccountPeer::ACCOUNT_TYPE_ID, AccountTypePeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Account objects pre-filled with their sfGuardUser objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	/**
	 * Selects a collection of Account objects pre-filled with their AccountType objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of Account objects.
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinAccountType(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Account) to the collection in $obj2 (sfGuardUser)
				$obj2->addAccount($obj1);
			} // if joined row not null

			// Add objects for joined AccountType rows
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (Account) to the collection in $obj3 (AccountType)
	...
	/**
	 * Selects a collection of Account objects pre-filled with all related objects except sfGuardUser.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAllExceptsfGuardUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = AccountPeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (Account) to the collection in $obj2 (AccountType)
				$obj2->addAccount($obj1);
	...
	/**
	 * Selects a collection of Account objects pre-filled with all related objects except AccountType.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinAllExceptAccountType(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
