...
abstract class BaseTicketType extends BaseObject  implements Persistent {
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = TicketTypePeer::NUM_COLUMNS - TicketTypePeer::NUM_LAZY_LOAD_COLUMNS).
	 ...
	 * Otherwise if this TicketType has previously been saved, it will retrieve
	 * related Tickets from storage. If this TicketType is new, it will return
