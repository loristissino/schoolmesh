...
/**
 * Base static class for performing query and update operations on the 'lanlog' table.
 *
 * 
 *
...
abstract class BaseLanlogPeer {
	...
	/** the column name for the OS_USED field */
	const OS_USED = 'lanlog.OS_USED';

	/**
	 * An identiy map to hold any loaded instances of Lanlog objects.
	 ...
	 * @param      string $column The column name for current table. (i.e. LanlogPeer::COLUMN_NAME).
	 * @return     string
	 */
	 ...
	 *
	 * @param      Lanlog $value A Lanlog object.
	 ...
	 *
	 * @param      mixed $value A Lanlog object or a primary key value.
	 */
	 ...
	 * @return     Lanlog Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	/**
	 * Method to invalidate the instance pool of all tables related to lanlog
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = LanlogPeer::getOMClass(false);
	...
	public static function doCountJoinsfGuardUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(LanlogPeer::USER_ID, sfGuardUserPeer::ID, $join_behavior);
	...
	public static function doCountJoinWorkstation(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(LanlogPeer::WORKSTATION_ID, WorkstationPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Lanlog objects pre-filled with their sfGuardUser objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of Lanlog objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 */
	...
	/**
	 * Selects a collection of Lanlog objects pre-filled with their Workstation objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of Lanlog objects.
	...
	/**
	 * Selects a collection of Lanlog objects pre-filled with all related objects.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Lanlog) to the collection in $obj2 (sfGuardUser)
				$obj2->addLanlog($obj1);
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (Lanlog) to the collection in $obj3 (Workstation)
				$obj3->addLanlog($obj1);
			} // if joined row not null
	...
	/**
	 * Selects a collection of Lanlog objects pre-filled with all related objects except sfGuardUser.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAllExceptsfGuardUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = LanlogPeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (Lanlog) to the collection in $obj2 (Workstation)
				$obj2->addLanlog($obj1);
	...
	/**
	 * Selects a collection of Lanlog objects pre-filled with all related objects except Workstation.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	{
	  $dbMap = Propel::getDatabaseMap(BaseLanlogPeer::DATABASE_NAME);
	  if (!$dbMap->hasTable(BaseLanlogPeer::TABLE_NAME))
	  {
	    $dbMap->addTableObject(new LanlogTableMap());
	  }
	}
	...
	{
		return $withPrefix ? LanlogPeer::CLASS_DEFAULT : LanlogPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a Lanlog or Criteria object.
	 *
	 * @param      mixed $values Criteria or Lanlog object containing data that is used to create the INSERT statement.
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from Lanlog object
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a Lanlog or Criteria object.
	 *
	 * @param      mixed $values Criteria or Lanlog object containing data that is used to create the UPDATE statement.
	...
	/**
	 * Method to DELETE all rows from the lanlog table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			LanlogPeer::clearRelatedInstancePool();
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
	...
	/**
	 * Method perform a DELETE on the database, given a Lanlog or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or Lanlog object or primary key or array of primary keys
	...
	/**
	 * Validates all modified columns of given Lanlog object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      Lanlog $obj The object to validate.
	...
	public static function doValidate(Lanlog $obj, $cols = null)
	{
		...
		return BasePeer::doValidate(LanlogPeer::DATABASE_NAME, LanlogPeer::TABLE_NAME, $columns);
	}
