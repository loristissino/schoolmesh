...
/**
 * Base static class for performing query and update operations on the 'wpitem_group' table.
 *
 * 
 *
...
abstract class BaseWpitemGroupPeer {
	...
	const OM_CLASS = 'WpitemGroup';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'lib.model.WpitemGroup';

	/** the related TableMap class for this table */
	const TM_CLASS = 'WpitemGroupTableMap';
	...
	/** the column name for the WPITEM_TYPE_ID field */
	...
	/**
	 * An identiy map to hold any loaded instances of WpitemGroup objects.
	 * This must be public so that other peer classes can access this when hydrating from JOIN
	 * queries.
	 * @var        array WpitemGroup[]
	 */
	 ...
	 * @param      string $column The column name for current table. (i.e. WpitemGroupPeer::COLUMN_NAME).
	 * @return     string
	 */
	 ...
	 *
	 * @param      WpitemGroup $value A WpitemGroup object.
	 ...
	 *
	 * @param      mixed $value A WpitemGroup object or a primary key value.
	 */
	 ...
	 * @return     WpitemGroup Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	/**
	 * Method to invalidate the instance pool of all tables related to wpitem_group
	 * by a foreign key with ON DELETE CASCADE
	 */
	public static function clearRelatedInstancePool()
	{
		// invalidate objects in WpmoduleItemPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = WpitemGroupPeer::getOMClass(false);
	...
	/**
	 * Returns the number of rows matching criteria, joining the related WpitemType table
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
	 * @param      PropelPDO $con
	...
	public static function doCountJoinWpitemType(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(WpitemGroupPeer::WPITEM_TYPE_ID, WpitemTypePeer::ID, $join_behavior);
	...
	public static function doCountJoinWpmodule(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(WpitemGroupPeer::WPMODULE_ID, WpmodulePeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of WpitemGroup objects pre-filled with their WpitemType objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of WpitemGroup objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinWpitemType(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
	...
	/**
	 * Selects a collection of WpitemGroup objects pre-filled with their Wpmodule objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of WpitemGroup objects.
	...
	/**
	 * Selects a collection of WpitemGroup objects pre-filled with all related objects.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			// Add objects for joined WpitemType rows
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (WpitemGroup) to the collection in $obj2 (WpitemType)
				$obj2->addWpitemGroup($obj1);
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (WpitemGroup) to the collection in $obj3 (Wpmodule)
	...
	/**
	 * Selects a collection of WpitemGroup objects pre-filled with all related objects except WpitemType.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinAllExceptWpitemType(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = WpitemGroupPeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (WpitemGroup) to the collection in $obj2 (Wpmodule)
				$obj2->addWpitemGroup($obj1);
	...
	/**
	 * Selects a collection of WpitemGroup objects pre-filled with all related objects except Wpmodule.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	{
	  $dbMap = Propel::getDatabaseMap(BaseWpitemGroupPeer::DATABASE_NAME);
	  if (!$dbMap->hasTable(BaseWpitemGroupPeer::TABLE_NAME))
	  {
	    $dbMap->addTableObject(new WpitemGroupTableMap());
	  }
	}
	...
	{
		return $withPrefix ? WpitemGroupPeer::CLASS_DEFAULT : WpitemGroupPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a WpitemGroup or Criteria object.
	 *
	 * @param      mixed $values Criteria or WpitemGroup object containing data that is used to create the INSERT statement.
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from WpitemGroup object
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a WpitemGroup or Criteria object.
	 *
	 * @param      mixed $values Criteria or WpitemGroup object containing data that is used to create the UPDATE statement.
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		} else { // $values is WpitemGroup object
	...
	/**
	 * Method to DELETE all rows from the wpitem_group table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			WpitemGroupPeer::clearRelatedInstancePool();
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
	...
	/**
	 * Method perform a DELETE on the database, given a WpitemGroup or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or WpitemGroup object or primary key or array of primary keys
	...
	/**
	 * Validates all modified columns of given WpitemGroup object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      WpitemGroup $obj The object to validate.
	...
	public static function doValidate(WpitemGroup $obj, $cols = null)
	{
		...
		return BasePeer::doValidate(WpitemGroupPeer::DATABASE_NAME, WpitemGroupPeer::TABLE_NAME, $columns);
	}
...
//
BaseWpitemGroupPeer::buildTableMap();
