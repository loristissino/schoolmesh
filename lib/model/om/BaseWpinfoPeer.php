...
/**
 * Base static class for performing query and update operations on the 'wpinfo' table.
 *
 * 
 *
...
abstract class BaseWpinfoPeer {
	...
	/** the column name for the WPINFO_TYPE_ID field */
	...
	/**
	 * An identiy map to hold any loaded instances of Wpinfo objects.
	 ...
	 * @param      string $column The column name for current table. (i.e. WpinfoPeer::COLUMN_NAME).
	 * @return     string
	 */
	 ...
	 *
	 * @param      Wpinfo $value A Wpinfo object.
	 ...
	 *
	 * @param      mixed $value A Wpinfo object or a primary key value.
	 */
	 ...
	 * @return     Wpinfo Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	/**
	 * Method to invalidate the instance pool of all tables related to wpinfo
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = WpinfoPeer::getOMClass(false);
	...
	public static function doCountJoinAppointment(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(WpinfoPeer::APPOINTMENT_ID, AppointmentPeer::ID, $join_behavior);
	...
	/**
	 * Returns the number of rows matching criteria, joining the related WpinfoType table
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
	 * @param      PropelPDO $con
	...
	public static function doCountJoinWpinfoType(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(WpinfoPeer::WPINFO_TYPE_ID, WpinfoTypePeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Wpinfo objects pre-filled with their Appointment objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of Wpinfo objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 */
	...
	/**
	 * Selects a collection of Wpinfo objects pre-filled with their WpinfoType objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of Wpinfo objects.
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinWpinfoType(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
	...
	/**
	 * Selects a collection of Wpinfo objects pre-filled with all related objects.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Wpinfo) to the collection in $obj2 (Appointment)
				$obj2->addWpinfo($obj1);
			} // if joined row not null

			// Add objects for joined WpinfoType rows
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (Wpinfo) to the collection in $obj3 (WpinfoType)
				$obj3->addWpinfo($obj1);
			} // if joined row not null
	...
	/**
	 * Selects a collection of Wpinfo objects pre-filled with all related objects except Appointment.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAllExceptAppointment(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = WpinfoPeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (Wpinfo) to the collection in $obj2 (WpinfoType)
				$obj2->addWpinfo($obj1);
	...
	/**
	 * Selects a collection of Wpinfo objects pre-filled with all related objects except WpinfoType.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinAllExceptWpinfoType(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
	...
	{
	  $dbMap = Propel::getDatabaseMap(BaseWpinfoPeer::DATABASE_NAME);
	  if (!$dbMap->hasTable(BaseWpinfoPeer::TABLE_NAME))
	  {
	    $dbMap->addTableObject(new WpinfoTableMap());
	  }
	}
	...
	{
		return $withPrefix ? WpinfoPeer::CLASS_DEFAULT : WpinfoPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a Wpinfo or Criteria object.
	 *
	 * @param      mixed $values Criteria or Wpinfo object containing data that is used to create the INSERT statement.
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from Wpinfo object
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a Wpinfo or Criteria object.
	 *
	 * @param      mixed $values Criteria or Wpinfo object containing data that is used to create the UPDATE statement.
	...
	/**
	 * Method to DELETE all rows from the wpinfo table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			WpinfoPeer::clearRelatedInstancePool();
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
	...
	/**
	 * Method perform a DELETE on the database, given a Wpinfo or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or Wpinfo object or primary key or array of primary keys
	...
	/**
	 * Validates all modified columns of given Wpinfo object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      Wpinfo $obj The object to validate.
	...
	public static function doValidate(Wpinfo $obj, $cols = null)
	{
		...
		return BasePeer::doValidate(WpinfoPeer::DATABASE_NAME, WpinfoPeer::TABLE_NAME, $columns);
	}
