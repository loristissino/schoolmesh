...
/**
 * Base static class for performing query and update operations on the 'enrolment' table.
 *
 * 
 *
...
abstract class BaseEnrolmentPeer {
	...
	const OM_CLASS = 'Enrolment';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'lib.model.Enrolment';

	/** the related TableMap class for this table */
	const TM_CLASS = 'EnrolmentTableMap';
	...
	/**
	 * An identiy map to hold any loaded instances of Enrolment objects.
	 ...
	 * @param      string $column The column name for current table. (i.e. EnrolmentPeer::COLUMN_NAME).
	 * @return     string
	 */
	 ...
	 *
	 * @param      Enrolment $value A Enrolment object.
	 ...
	 *
	 * @param      mixed $value A Enrolment object or a primary key value.
	 */
	 ...
	 * @return     Enrolment Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	/**
	 * Method to invalidate the instance pool of all tables related to enrolment
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = EnrolmentPeer::getOMClass(false);
	...
	public static function doCountJoinsfGuardUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(EnrolmentPeer::USER_ID, sfGuardUserPeer::ID, $join_behavior);
	...
	public static function doCountJoinSchoolclass(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(EnrolmentPeer::SCHOOLCLASS_ID, SchoolclassPeer::ID, $join_behavior);
	...
	public static function doCountJoinYear(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(EnrolmentPeer::YEAR_ID, YearPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Enrolment objects pre-filled with their sfGuardUser objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinsfGuardUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Enrolment) to $obj2 (sfGuardUser)
	...
	/**
	 * Selects a collection of Enrolment objects pre-filled with their Schoolclass objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of Enrolment objects.
	...
	public static function doSelectJoinSchoolclass(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Enrolment) to $obj2 (Schoolclass)
				$obj2->addEnrolment($obj1);
	...
	/**
	 * Selects a collection of Enrolment objects pre-filled with their Year objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of Enrolment objects.
	...
	public static function doSelectJoinYear(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Enrolment) to $obj2 (Year)
				$obj2->addEnrolment($obj1);
	...
	/**
	 * Selects a collection of Enrolment objects pre-filled with all related objects.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Enrolment) to the collection in $obj2 (sfGuardUser)
				$obj2->addEnrolment($obj1);
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (Enrolment) to the collection in $obj3 (Schoolclass)
			...
			if ($key4 !== null) {
				...
				// Add the $obj1 (Enrolment) to the collection in $obj4 (Year)
	...
	/**
	 * Selects a collection of Enrolment objects pre-filled with all related objects except sfGuardUser.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAllExceptsfGuardUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = EnrolmentPeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (Enrolment) to the collection in $obj2 (Schoolclass)
				$obj2->addEnrolment($obj1);
				...
				// Add the $obj1 (Enrolment) to the collection in $obj3 (Year)
				$obj3->addEnrolment($obj1);
	...
	/**
	 * Selects a collection of Enrolment objects pre-filled with all related objects except Schoolclass.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	/**
	 * Selects a collection of Enrolment objects pre-filled with all related objects except Year.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	{
	  $dbMap = Propel::getDatabaseMap(BaseEnrolmentPeer::DATABASE_NAME);
	  if (!$dbMap->hasTable(BaseEnrolmentPeer::TABLE_NAME))
	  {
	    $dbMap->addTableObject(new EnrolmentTableMap());
	  }
	}
	...
	{
		return $withPrefix ? EnrolmentPeer::CLASS_DEFAULT : EnrolmentPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a Enrolment or Criteria object.
	 *
	 * @param      mixed $values Criteria or Enrolment object containing data that is used to create the INSERT statement.
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from Enrolment object
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a Enrolment or Criteria object.
	 *
	 * @param      mixed $values Criteria or Enrolment object containing data that is used to create the UPDATE statement.
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		} else { // $values is Enrolment object
	...
	/**
	 * Method to DELETE all rows from the enrolment table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			EnrolmentPeer::clearRelatedInstancePool();
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
	...
	/**
	 * Method perform a DELETE on the database, given a Enrolment or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or Enrolment object or primary key or array of primary keys
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof Enrolment) { // it's a model object
	...
	/**
	 * Validates all modified columns of given Enrolment object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      Enrolment $obj The object to validate.
	...
	public static function doValidate(Enrolment $obj, $cols = null)
	{
		...
		return BasePeer::doValidate(EnrolmentPeer::DATABASE_NAME, EnrolmentPeer::TABLE_NAME, $columns);
	}
...
//
BaseEnrolmentPeer::buildTableMap();
