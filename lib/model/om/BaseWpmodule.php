...
/**
 * Base class that represents a row from the 'wpmodule' table.
 *
 * 
 *
...
abstract class BaseWpmodule extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the hours_used field.
	 * Note: this column has a database default value of: 0
	 * @var        int
	 */
	...
	/**
	 * @var        Criteria The criteria used to select the current contents of collWpmoduleSyllabusItems.
	 */
	...
	/**
	 * Initializes internal state of BaseWpmodule object.
	 * @see        applyDefaults()
	 */
	...
	/**
	 * Get the [hours_used] column value.
	 * 
	 * @return     int
	 */
	 ...
	 * @return     Wpmodule The current object (for fluent API support)
	 */
	...
	public function setHoursEstimated($v)
	{
		...
		if ($this->hours_estimated !== $v || $this->isNew()) {
	...
	/**
	 * Set the value of [hours_used] column.
	 * 
	 * @param      int $v new value
	 * @return     Wpmodule The current object (for fluent API support)
	 */
	public function setHoursUsed($v)
	{
		...
		if ($this->hours_used !== $v || $this->isNew()) {
			$this->hours_used = $v;
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 11; // 11 = WpmodulePeer::NUM_COLUMNS - WpmodulePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($isInsert) {
				...
				// symfony_timestampable behavior
				if (!$this->isColumnModified(WpmodulePeer::CREATED_AT))
				{
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Wpmodule (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Wpmodule Clone of current object.
	 * @throws     PropelException
	 */
	...
	public function getsfGuardUser(PropelPDO $con = null)
	{
		if ($this->asfGuardUser === null && ($this->user_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->asfGuardUser->addWpmodules($this);
			 */
		}
	...
	public function getAppointment(PropelPDO $con = null)
	{
		if ($this->aAppointment === null && ($this->appointment_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aAppointment->addWpmodules($this);
			 */
		}
	 ...
	 * Otherwise if this Wpmodule has previously been saved, it will retrieve
	 * related WpitemGroups from storage. If this Wpmodule is new, it will return
	 ...
	 * Otherwise if this Wpmodule is new, it will return
	 * an empty collection; or if this Wpmodule has previously
	 * been saved, it will retrieve related WpitemGroups from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in Wpmodule.
	 */
	 ...
	 *
	 * @return     void
	 * @see        addWpmoduleSyllabusItems()
	 */
	public function clearWpmoduleSyllabusItems()
	{
		$this->collWpmoduleSyllabusItems = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collWpmoduleSyllabusItems collection (array).
	 *
	 * By default this just sets the collWpmoduleSyllabusItems collection to an empty array (like clearcollWpmoduleSyllabusItems());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	 */
	public function initWpmoduleSyllabusItems()
	{
		$this->collWpmoduleSyllabusItems = array();
	}

	/**
	 * Gets an array of WpmoduleSyllabusItem objects which contain a foreign key that references this object.
	 *
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Wpmodule has previously been saved, it will retrieve
	 * related WpmoduleSyllabusItems from storage. If this Wpmodule is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 * @return     array WpmoduleSyllabusItem[]
	 * @throws     PropelException
	 */
	public function getWpmoduleSyllabusItems($criteria = null, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(WpmodulePeer::DATABASE_NAME);
		}
		...
		if ($this->collWpmoduleSyllabusItems === null) {
			if ($this->isNew()) {
			   $this->collWpmoduleSyllabusItems = array();
				...
				$criteria->add(WpmoduleSyllabusItemPeer::WPMODULE_ID, $this->id);

				WpmoduleSyllabusItemPeer::addSelectColumns($criteria);
				$this->collWpmoduleSyllabusItems = WpmoduleSyllabusItemPeer::doSelect($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				WpmoduleSyllabusItemPeer::addSelectColumns($criteria);
				if (!isset($this->lastWpmoduleSyllabusItemCriteria) || !$this->lastWpmoduleSyllabusItemCriteria->equals($criteria)) {
					$this->collWpmoduleSyllabusItems = WpmoduleSyllabusItemPeer::doSelect($criteria, $con);
				}
			}
		}
		$this->lastWpmoduleSyllabusItemCriteria = $criteria;
		return $this->collWpmoduleSyllabusItems;
	}

	/**
	 * Returns the number of related WpmoduleSyllabusItem objects.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      PropelPDO $con
	 * @return     int Count of related WpmoduleSyllabusItem objects.
	 * @throws     PropelException
	 */
	public function countWpmoduleSyllabusItems(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(WpmodulePeer::DATABASE_NAME);
		} else {
		...
		if ($this->collWpmoduleSyllabusItems === null) {
			if ($this->isNew()) {
				...
				$count = WpmoduleSyllabusItemPeer::doCount($criteria, false, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				if (!isset($this->lastWpmoduleSyllabusItemCriteria) || !$this->lastWpmoduleSyllabusItemCriteria->equals($criteria)) {
					...
					$count = count($this->collWpmoduleSyllabusItems);
				}
			} else {
				$count = count($this->collWpmoduleSyllabusItems);
			}
	...
	/**
	 * Method called to associate a WpmoduleSyllabusItem object to this object
	 * through the WpmoduleSyllabusItem foreign key attribute.
	 *
	 * @param      WpmoduleSyllabusItem $l WpmoduleSyllabusItem
	 * @return     void
	 * @throws     PropelException
	 */
	public function addWpmoduleSyllabusItem(WpmoduleSyllabusItem $l)
	{
		if ($this->collWpmoduleSyllabusItems === null) {
			$this->initWpmoduleSyllabusItems();
		}
		if (!in_array($l, $this->collWpmoduleSyllabusItems, true)) { // only add it if the **same** object is not already associated
			array_push($this->collWpmoduleSyllabusItems, $l);
			$l->setWpmodule($this);
		}
	}
	 ...
	 * Otherwise if this Wpmodule is new, it will return
	 * an empty collection; or if this Wpmodule has previously
	 * been saved, it will retrieve related WpmoduleSyllabusItems from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in Wpmodule.
	 */
	public function getWpmoduleSyllabusItemsJoinSyllabusItem($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(WpmodulePeer::DATABASE_NAME);
		}
		...
		if ($this->collWpmoduleSyllabusItems === null) {
			if ($this->isNew()) {
				...
				$this->collWpmoduleSyllabusItems = WpmoduleSyllabusItemPeer::doSelectJoinSyllabusItem($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
