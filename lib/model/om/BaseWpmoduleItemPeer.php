...
/**
 * Base static class for performing query and update operations on the 'wpmodule_item' table.
 *
 * 
 *
...
abstract class BaseWpmoduleItemPeer {
	...
	const OM_CLASS = 'WpmoduleItem';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'lib.model.WpmoduleItem';

	/** the related TableMap class for this table */
	const TM_CLASS = 'WpmoduleItemTableMap';
	...
	/** the column name for the WPITEM_GROUP_ID field */
	...
	/**
	 * An identiy map to hold any loaded instances of WpmoduleItem objects.
	 * This must be public so that other peer classes can access this when hydrating from JOIN
	 * queries.
	 * @var        array WpmoduleItem[]
	 */
	 ...
	 * @param      string $column The column name for current table. (i.e. WpmoduleItemPeer::COLUMN_NAME).
	 * @return     string
	 */
	 ...
	 *
	 * @param      WpmoduleItem $value A WpmoduleItem object.
	 ...
	 *
	 * @param      mixed $value A WpmoduleItem object or a primary key value.
	 */
	 ...
	 * @return     WpmoduleItem Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	/**
	 * Method to invalidate the instance pool of all tables related to wpmodule_item
	...
	/**
	 * Returns the number of rows matching criteria, joining the related WpitemGroup table
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
	 * @param      PropelPDO $con
	...
	public static function doCountJoinWpitemGroup(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(WpmoduleItemPeer::WPITEM_GROUP_ID, WpitemGroupPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of WpmoduleItem objects pre-filled with their WpitemGroup objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of WpmoduleItem objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinWpitemGroup(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (WpmoduleItem) to $obj2 (WpitemGroup)
	...
	/**
	 * Selects a collection of WpmoduleItem objects pre-filled with all related objects.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			// Add objects for joined WpitemGroup rows
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (WpmoduleItem) to the collection in $obj2 (WpitemGroup)
				$obj2->addWpmoduleItem($obj1);
	...
	{
	  $dbMap = Propel::getDatabaseMap(BaseWpmoduleItemPeer::DATABASE_NAME);
	  if (!$dbMap->hasTable(BaseWpmoduleItemPeer::TABLE_NAME))
	  {
	    $dbMap->addTableObject(new WpmoduleItemTableMap());
	  }
	}
	...
	{
		return $withPrefix ? WpmoduleItemPeer::CLASS_DEFAULT : WpmoduleItemPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a WpmoduleItem or Criteria object.
	 *
	 * @param      mixed $values Criteria or WpmoduleItem object containing data that is used to create the INSERT statement.
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from WpmoduleItem object
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a WpmoduleItem or Criteria object.
	 *
	 * @param      mixed $values Criteria or WpmoduleItem object containing data that is used to create the UPDATE statement.
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		} else { // $values is WpmoduleItem object
	...
	/**
	 * Method to DELETE all rows from the wpmodule_item table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			WpmoduleItemPeer::clearRelatedInstancePool();
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
	...
	/**
	 * Method perform a DELETE on the database, given a WpmoduleItem or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or WpmoduleItem object or primary key or array of primary keys
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof WpmoduleItem) { // it's a model object
	...
	/**
	 * Validates all modified columns of given WpmoduleItem object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      WpmoduleItem $obj The object to validate.
	...
	public static function doValidate(WpmoduleItem $obj, $cols = null)
	{
		...
		return BasePeer::doValidate(WpmoduleItemPeer::DATABASE_NAME, WpmoduleItemPeer::TABLE_NAME, $columns);
	}
...
} // BaseWpmoduleItemPeer

// This is the static code needed to register the TableMap for this table with the main Propel class.
//
BaseWpmoduleItemPeer::buildTableMap();
