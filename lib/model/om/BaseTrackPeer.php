...
abstract class BaseTrackPeer {
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new TrackMapBuilder();
		}
...
Propel::getDatabaseMap(BaseTrackPeer::DATABASE_NAME)->addTableBuilder(BaseTrackPeer::TABLE_NAME, BaseTrackPeer::getMapBuilder());
