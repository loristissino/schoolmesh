...
/**
 * Base class that represents a row from the 'subnet_service' table.
 *
 * 
 *
...
abstract class BaseSubnetService extends BaseObject  implements Persistent {
	 ...
	 * @return     SubnetService The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = SubnetServicePeer::NUM_COLUMNS - SubnetServicePeer::NUM_LAZY_LOAD_COLUMNS).
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of SubnetService (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     SubnetService Clone of current object.
	 * @throws     PropelException
	 */
	...
	public function getSubnet(PropelPDO $con = null)
	{
		if ($this->aSubnet === null && ($this->subnet_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aSubnet->addSubnetServices($this);
			 */
		}
		return $this->aSubnet;
	}
	...
	public function getService(PropelPDO $con = null)
	{
		if ($this->aService === null && ($this->service_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aService->addSubnetServices($this);
			 */
		}
