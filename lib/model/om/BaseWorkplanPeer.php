...
abstract class BaseWorkplanPeer {

	
	const DATABASE_NAME = 'propel';

	
	const TABLE_NAME = 'workplan';
	...
	const USER_ID = 'workplan.USER_ID';

	
	const YEAR_ID = 'workplan.YEAR_ID';

	
	const SCHOOLCLASS_ID = 'workplan.SCHOOLCLASS_ID';

	
	const SUBJECT_ID = 'workplan.SUBJECT_ID';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'UserId', 'YearId', 'SchoolclassId', 'SubjectId', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'userId', 'yearId', 'schoolclassId', 'subjectId', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::USER_ID, self::YEAR_ID, self::SCHOOLCLASS_ID, self::SUBJECT_ID, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'user_id', 'year_id', 'schoolclass_id', 'subject_id', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UserId' => 1, 'YearId' => 2, 'SchoolclassId' => 3, 'SubjectId' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'userId' => 1, 'yearId' => 2, 'schoolclassId' => 3, 'subjectId' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USER_ID => 1, self::YEAR_ID => 2, self::SCHOOLCLASS_ID => 3, self::SUBJECT_ID => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'user_id' => 1, 'year_id' => 2, 'schoolclass_id' => 3, 'subject_id' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new WorkplanMapBuilder();
		}
	...
	{
		return str_replace(WorkplanPeer::TABLE_NAME.'.', $alias.'.', $column);
	}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(WorkplanPeer::ID);

		$criteria->addSelectColumn(WorkplanPeer::USER_ID);

		$criteria->addSelectColumn(WorkplanPeer::YEAR_ID);

		$criteria->addSelectColumn(WorkplanPeer::SCHOOLCLASS_ID);

		$criteria->addSelectColumn(WorkplanPeer::SUBJECT_ID);
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
				$criteria = clone $criteria;
								...
								$criteria->setPrimaryTableName(WorkplanPeer::TABLE_NAME);
	...
	public static function doSelectOne(Criteria $criteria, PropelPDO $con = null)
	{
		...
		$critcopy->setLimit(1);
		$objects = WorkplanPeer::doSelect($critcopy, $con);
		if ($objects) {
			return $objects[0];
		}
		return null;
	...
	{
		return WorkplanPeer::populateObjects(WorkplanPeer::doSelectStmt($criteria, $con));
	}
	...
	public static function addInstanceToPool(Workplan $obj, $key = null)
	{
	...
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof Workplan) {
				$key = (string) $value->getId();
			} elseif (is_scalar($value)) {
								$key = (string) $value;
			} else {
				$e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or Workplan object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		$results = array();
				...
				$cls = WorkplanPeer::getOMClass();
		$cls = substr('.'.$cls, strrpos('.'.$cls, '.') + 1);
				while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key = WorkplanPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj = WorkplanPeer::getInstanceFromPool($key))) {
																$results[] = $obj;
			} else {
				...
				$obj->hydrate($row);
				$results[] = $obj;
				WorkplanPeer::addInstanceToPool($obj, $key);
			} 		}
		$stmt->closeCursor();
		return $results;
	}
	...
	public static function doCountJoinsfGuardUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(WorkplanPeer::USER_ID,), array(sfGuardUserPeer::ID,), $join_behavior);
	...
	public static function doCountJoinYear(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(WorkplanPeer::YEAR_ID,), array(YearPeer::ID,), $join_behavior);
	...
	public static function doCountJoinSchoolclass(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(WorkplanPeer::SCHOOLCLASS_ID,), array(SchoolclassPeer::ID,), $join_behavior);
	...
	public static function doCountJoinSubject(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(WorkplanPeer::SUBJECT_ID,), array(SubjectPeer::ID,), $join_behavior);
	...
	public static function doSelectJoinsfGuardUser(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$startcol = (WorkplanPeer::NUM_COLUMNS - WorkplanPeer::NUM_LAZY_LOAD_COLUMNS);
		sfGuardUserPeer::addSelectColumns($c);

		$c->addJoin(array(WorkplanPeer::USER_ID,), array(sfGuardUserPeer::ID,), $join_behavior);
		$stmt = BasePeer::doSelect($c, $con);
		$results = array();

		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key1 = WorkplanPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj1 = WorkplanPeer::getInstanceFromPool($key1))) {
															} else {
				...
				$obj1 = new $cls();
				$obj1->hydrate($row);
				WorkplanPeer::addInstanceToPool($obj1, $key1);
			} 
	...
	public static function doSelectJoinYear(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$c->addJoin(array(WorkplanPeer::YEAR_ID,), array(YearPeer::ID,), $join_behavior);
		$stmt = BasePeer::doSelect($c, $con);
		$results = array();
	...
	public static function doSelectJoinSchoolclass(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$c->addJoin(array(WorkplanPeer::SCHOOLCLASS_ID,), array(SchoolclassPeer::ID,), $join_behavior);
		$stmt = BasePeer::doSelect($c, $con);
		$results = array();
	...
	public static function doSelectJoinSubject(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$c->addJoin(array(WorkplanPeer::SUBJECT_ID,), array(SubjectPeer::ID,), $join_behavior);
		$stmt = BasePeer::doSelect($c, $con);
		$results = array();
	...
	public static function doSelectJoinAll(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		WorkplanPeer::addSelectColumns($c);
		$startcol2 = (WorkplanPeer::NUM_COLUMNS - WorkplanPeer::NUM_LAZY_LOAD_COLUMNS);
  ...
  {
    return array(array('user_id', 'year_id', 'schoolclass_id', 'subject_id'));
  }
	...
	{
		return WorkplanPeer::CLASS_DEFAULT;
	}
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($criteria->containsKey(WorkplanPeer::ID) && $criteria->keyContainsValue(WorkplanPeer::ID) ) {
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(WorkplanPeer::ID);
			$selectCriteria->add(WorkplanPeer::ID, $criteria->remove(WorkplanPeer::ID), $comparison);
	...
	public static function doDeleteAll($con = null)
	{
		...
		$affectedRows = 0; 		try {
									$con->beginTransaction();
			$affectedRows += BasePeer::doDeleteAll(WorkplanPeer::TABLE_NAME, $con);
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
	 ...
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
												WorkplanPeer::clearInstancePool();

						$criteria = clone $values;
		} elseif ($values instanceof Workplan) {
						WorkplanPeer::removeInstanceFromPool($values);
			...
			$criteria->add(WorkplanPeer::ID, (array) $values, Criteria::IN);

			foreach ((array) $values as $singleval) {
								WorkplanPeer::removeInstanceFromPool($singleval);
			}
		}
	...
	public static function doValidate(Workplan $obj, $cols = null)
	{
		$columns = array();

		if ($cols) {
			$dbMap = Propel::getDatabaseMap(WorkplanPeer::DATABASE_NAME);
			$tableMap = $dbMap->getTable(WorkplanPeer::TABLE_NAME);
		...
		$res =  BasePeer::doValidate(WorkplanPeer::DATABASE_NAME, WorkplanPeer::TABLE_NAME, $columns);
    if ($res !== true) {
        $request = sfContext::getInstance()->getRequest();
        foreach ($res as $failed) {
            $col = WorkplanPeer::translateFieldname($failed->getColumn(), BasePeer::TYPE_COLNAME, BasePeer::TYPE_PHPNAME);
        }
    }
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		if (null !== ($obj = WorkplanPeer::getInstanceFromPool((string) $pk))) {
			return $obj;
		}
		...
		$criteria->add(WorkplanPeer::ID, $pk);

		$v = WorkplanPeer::doSelect($criteria, $con);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(WorkplanPeer::DATABASE_NAME);
			$criteria->add(WorkplanPeer::ID, $pks, Criteria::IN);
			$objs = WorkplanPeer::doSelect($criteria, $con);
		}
		return $objs;
	}
...
Propel::getDatabaseMap(BaseWorkplanPeer::DATABASE_NAME)->addTableBuilder(BaseWorkplanPeer::TABLE_NAME, BaseWorkplanPeer::getMapBuilder());
