...
/**
 * Base class that represents a row from the 'reserved_username' table.
 *
 * 
 *
...
abstract class BaseReservedUsername extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the aliases_to field.
	 * @var        string
	 */
	...
	/**
	 * Get the [aliases_to] column value.
	 * 
	 * @return     string
	 */
	 ...
	 * @return     ReservedUsername The current object (for fluent API support)
	 */
	...
	/**
	 * Set the value of [aliases_to] column.
	 * 
	 * @param      string $v new value
	 * @return     ReservedUsername The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = ReservedUsernamePeer::NUM_COLUMNS - ReservedUsernamePeer::NUM_LAZY_LOAD_COLUMNS).
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of ReservedUsername (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     ReservedUsername Clone of current object.
	 * @throws     PropelException
	 */
