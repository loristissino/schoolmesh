...
abstract class BaseSchoolclassPeer {
	...
	const TABLE_NAME = 'schoolclass';

	
	const CLASS_DEFAULT = 'lib.model.Schoolclass';
	...
	const TRACK_ID = 'schoolclass.TRACK_ID';
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new SchoolclassMapBuilder();
		}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(SchoolclassPeer::GRADE);
	...
	public static function doCountJoinTrack(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(SchoolclassPeer::TRACK_ID,), array(TrackPeer::ID,), $join_behavior);
	...
	public static function doSelectJoinTrack(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$c = clone $c;
		...
		$c->addJoin(array(SchoolclassPeer::TRACK_ID,), array(TrackPeer::ID,), $join_behavior);
  ...
  static public function getUniqueColumnNames()
  {
	...
	{
		return SchoolclassPeer::CLASS_DEFAULT;
	}
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$selectCriteria->add(SchoolclassPeer::ID, $criteria->remove(SchoolclassPeer::ID), $comparison);
	...
	public static function doDeleteAll($con = null)
	{
		...
		$affectedRows = 0; 		try {
									$con->beginTransaction();
			$affectedRows += BasePeer::doDeleteAll(SchoolclassPeer::TABLE_NAME, $con);
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
	...
	public static function doValidate(Schoolclass $obj, $cols = null)
	{
		...
		$res =  BasePeer::doValidate(SchoolclassPeer::DATABASE_NAME, SchoolclassPeer::TABLE_NAME, $columns);
    if ($res !== true) {
        $request = sfContext::getInstance()->getRequest();
        foreach ($res as $failed) {
            $col = SchoolclassPeer::translateFieldname($failed->getColumn(), BasePeer::TYPE_COLNAME, BasePeer::TYPE_PHPNAME);
        }
    }
...
Propel::getDatabaseMap(BaseSchoolclassPeer::DATABASE_NAME)->addTableBuilder(BaseSchoolclassPeer::TABLE_NAME, BaseSchoolclassPeer::getMapBuilder());
