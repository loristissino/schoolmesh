<?xml version="1.0" encoding="utf-8"?>
       <feed xmlns="http://www.w3.org/2005/Atom">
        ...
        <updated><?php echo gmstrftime('%Y-%m-%dT%H:%M:%SZ',
                LanlogPeer::getLatestLog()->getUpdatedAt('U')) ?></updated>
...
<?php foreach ($lanlog_list as $lanlog): ?>
         <entry>
           ...
           <summary><?php echo $lanlog->getsfGuardUser()->getProfile()->getFullname() ?> (<?php echo $lanlog->getsfGuardUser()->getUsername() ?>) is logged on <?php echo $lanlog->getWorkstation() ?></summary>
