...
class SentencePeer{
	...
	'users_bulk_upload_appointments_format'=>'username,class,subject_id,hours,syllabus_id',
	'users_bulk_upload_appointments_example'=>"bruna.bagala,3AP,ING,99,3\nmarco.defilippis,4AP,INF,165,3\n...",
