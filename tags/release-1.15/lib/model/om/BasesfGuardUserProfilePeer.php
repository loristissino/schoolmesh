...
abstract class BasesfGuardUserProfilePeer {
	...
	/** the column name for the PLAINTEXT_PASSWORD field */
	const PLAINTEXT_PASSWORD = 'sf_guard_user_profile.PLAINTEXT_PASSWORD';

	/** the column name for the ENCRYPTED_PASSWORD field */
	const ENCRYPTED_PASSWORD = 'sf_guard_user_profile.ENCRYPTED_PASSWORD';
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(sfGuardUserProfilePeer::MOBILE);
		...
		$criteria->addSelectColumn(sfGuardUserProfilePeer::PLAINTEXT_PASSWORD);
		$criteria->addSelectColumn(sfGuardUserProfilePeer::ENCRYPTED_PASSWORD);
	}
