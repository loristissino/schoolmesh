...
/**
 * Base static class for performing query and update operations on the 'schoolclass' table.
 *
 * 
 *
...
abstract class BaseSchoolclassPeer {
	...
	/**
	 * Method to invalidate the instance pool of all tables related to schoolclass
	...
	public static function doCountJoinTrack(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(SchoolclassPeer::TRACK_ID, TrackPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Schoolclass objects pre-filled with their Track objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Schoolclass) to the collection in $obj2 (Track)
				$obj2->addSchoolclass($obj1);
	...
	/**
	 * Method to DELETE all rows from the schoolclass table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
