...
/**
 * This class defines the structure of the 'student_suggestion' table.
 *
 *
 *
 ...
 */
class StudentSuggestionTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.StudentSuggestionTableMap';
	...
	{
	  // attributes
		$this->setName('student_suggestion');
		$this->setPhpName('StudentSuggestion');
		$this->setClassname('StudentSuggestion');
		...
		$this->addForeignKey('SUGGESTION_ID', 'SuggestionId', 'INTEGER', 'suggestion', 'ID', false, null, null);
		// validators
	} // initialize()
    ...
    $this->addRelation('Suggestion', 'Suggestion', RelationMap::MANY_TO_ONE, array('suggestion_id' => 'id', ), null, null);
	} // buildRelations()
