...
/**
 * Base static class for performing query and update operations on the 'workstation' table.
 *
 * 
 *
...
abstract class BaseWorkstationPeer {
	...
	/**
	 * An identiy map to hold any loaded instances of Workstation objects.
	 * This must be public so that other peer classes can access this when hydrating from JOIN
	 * queries.
	 * @var        array Workstation[]
	 */
	 ...
	 * @param      string $column The column name for current table. (i.e. WorkstationPeer::COLUMN_NAME).
	 * @return     string
	 */
	 ...
	 *
	 * @param      Workstation $value A Workstation object.
	 ...
	 *
	 * @param      mixed $value A Workstation object or a primary key value.
	 */
	 ...
	 * @return     Workstation Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	/**
	 * Method to invalidate the instance pool of all tables related to workstation
	...
	public static function doCountJoinSubnet(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(WorkstationPeer::SUBNET_ID, SubnetPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Workstation objects pre-filled with their Subnet objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	/**
	 * Selects a collection of Workstation objects pre-filled with all related objects.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Workstation) to the collection in $obj2 (Subnet)
				$obj2->addWorkstation($obj1);
	...
	{
	  $dbMap = Propel::getDatabaseMap(BaseWorkstationPeer::DATABASE_NAME);
	  if (!$dbMap->hasTable(BaseWorkstationPeer::TABLE_NAME))
	  {
	    $dbMap->addTableObject(new WorkstationTableMap());
	  }
	}
	...
	{
		return $withPrefix ? WorkstationPeer::CLASS_DEFAULT : WorkstationPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a Workstation or Criteria object.
	 *
	 * @param      mixed $values Criteria or Workstation object containing data that is used to create the INSERT statement.
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from Workstation object
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a Workstation or Criteria object.
	 *
	 * @param      mixed $values Criteria or Workstation object containing data that is used to create the UPDATE statement.
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		} else { // $values is Workstation object
	...
	/**
	 * Method to DELETE all rows from the workstation table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			WorkstationPeer::clearRelatedInstancePool();
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
	...
	/**
	 * Method perform a DELETE on the database, given a Workstation or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or Workstation object or primary key or array of primary keys
	...
	/**
	 * Validates all modified columns of given Workstation object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      Workstation $obj The object to validate.
	...
	public static function doValidate(Workstation $obj, $cols = null)
	{
		...
		return BasePeer::doValidate(WorkstationPeer::DATABASE_NAME, WorkstationPeer::TABLE_NAME, $columns);
	}
...
//
BaseWorkstationPeer::buildTableMap();
