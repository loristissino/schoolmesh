...
/**
 * Base class that represents a row from the 'wptool_item' table.
 *
 * 
 *
...
abstract class BaseWptoolItem extends BaseObject  implements Persistent {
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of WptoolItem (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     WptoolItem Clone of current object.
	 * @throws     PropelException
	 */
	...
	/**
	 * Declares an association between this object and a WptoolItemType object.
	 *
	 * @param      WptoolItemType $v
	 * @return     WptoolItem The current object (for fluent API support)
	 * @throws     PropelException
	 */
	public function setWptoolItemType(WptoolItemType $v = null)
	{
		...
		// If this object has already been added to the WptoolItemType object, it will not be re-added.
		if ($v !== null) {
	...
	/**
	 * Get the associated WptoolItemType object
	 *
	 * @param      PropelPDO Optional Connection object.
	 * @return     WptoolItemType The associated WptoolItemType object.
	 * @throws     PropelException
	 */
	public function getWptoolItemType(PropelPDO $con = null)
	{
		if ($this->aWptoolItemType === null && ($this->wptool_item_type_id !== null)) {
			$this->aWptoolItemType = WptoolItemTypePeer::retrieveByPk($this->wptool_item_type_id);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aWptoolItemType->addWptoolItems($this);
			 */
		}
	 ...
	 * Otherwise if this WptoolItem has previously been saved, it will retrieve
	 * related WptoolAppointments from storage. If this WptoolItem is new, it will return
	 ...
	 * Otherwise if this WptoolItem is new, it will return
	 * an empty collection; or if this WptoolItem has previously
	 * been saved, it will retrieve related WptoolAppointments from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in WptoolItem.
	 */
