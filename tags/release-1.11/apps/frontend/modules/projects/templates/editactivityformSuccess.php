...
<?php include_partial('content/breadcrumps', array(
  ...
  'current'=>__('Edit activity'),
  'title'=>__('Edit activity within the project «%project%»', array('%project%'=>$project->__toString()))
  ))
?>

<?php include_partial('content/flashes'); ?>

<form action="<?php echo url_for('projects/editactivity?id=' . $activity->getId()) ?>" method="post">
