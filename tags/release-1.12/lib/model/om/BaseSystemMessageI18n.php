...
/**
 * Base class that represents a row from the 'system_message_i18n' table.
 *
 * 
 *
...
abstract class BaseSystemMessageI18n extends BaseObject  implements Persistent {
	 ...
	 * @return     SystemMessageI18n The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = SystemMessageI18nPeer::NUM_COLUMNS - SystemMessageI18nPeer::NUM_LAZY_LOAD_COLUMNS).
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of SystemMessageI18n (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     SystemMessageI18n Clone of current object.
	 * @throws     PropelException
	 */
	...
	/**
	 * Declares an association between this object and a SystemMessage object.
	 *
	 * @param      SystemMessage $v
	 * @return     SystemMessageI18n The current object (for fluent API support)
	 * @throws     PropelException
	 */
	public function setSystemMessage(SystemMessage $v = null)
	{
		...
		// If this object has already been added to the SystemMessage object, it will not be re-added.
		if ($v !== null) {
	...
	/**
	 * Get the associated SystemMessage object
	 *
	 * @param      PropelPDO Optional Connection object.
	 * @return     SystemMessage The associated SystemMessage object.
	 * @throws     PropelException
	 */
	public function getSystemMessage(PropelPDO $con = null)
	{
		if ($this->aSystemMessage === null && ($this->id !== null)) {
			$this->aSystemMessage = SystemMessagePeer::retrieveByPk($this->id);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aSystemMessage->addSystemMessageI18ns($this);
			 */
		}
