...
/**
 * Base class that represents a row from the 'wptool_appointment' table.
 *
 * 
 *
...
abstract class BaseWptoolAppointment extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the wptool_item_id field.
	 * @var        int
	 */
	...
	/**
	 * Get the [wptool_item_id] column value.
	 * 
	 * @return     int
	 */
	 ...
	 * @return     WptoolAppointment The current object (for fluent API support)
	 */
	...
	/**
	 * Set the value of [wptool_item_id] column.
	 * 
	 * @param      int $v new value
	 * @return     WptoolAppointment The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = WptoolAppointmentPeer::NUM_COLUMNS - WptoolAppointmentPeer::NUM_LAZY_LOAD_COLUMNS).
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of WptoolAppointment (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     WptoolAppointment Clone of current object.
	 * @throws     PropelException
	 */
	...
	public function getAppointment(PropelPDO $con = null)
	{
		if ($this->aAppointment === null && ($this->appointment_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aAppointment->addWptoolAppointments($this);
			 */
		}
	...
	/**
	 * Declares an association between this object and a WptoolItem object.
	 *
	 * @param      WptoolItem $v
	 * @return     WptoolAppointment The current object (for fluent API support)
	 * @throws     PropelException
	...
	public function setWptoolItem(WptoolItem $v = null)
	{
		...
		// Add binding for other direction of this n:n relationship.
		// If this object has already been added to the WptoolItem object, it will not be re-added.
		if ($v !== null) {
			$v->addWptoolAppointment($this);
		}
	...
	/**
	 * Get the associated WptoolItem object
	 *
	 * @param      PropelPDO Optional Connection object.
	 * @return     WptoolItem The associated WptoolItem object.
	 * @throws     PropelException
	 */
	public function getWptoolItem(PropelPDO $con = null)
	{
		if ($this->aWptoolItem === null && ($this->wptool_item_id !== null)) {
			$this->aWptoolItem = WptoolItemPeer::retrieveByPk($this->wptool_item_id);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aWptoolItem->addWptoolAppointments($this);
			 */
		}
