...
abstract class BaseTrack extends BaseObject  implements Persistent {
	...
	/**
	 * @var        Criteria The criteria used to select the current contents of collSchoolclasss.
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = TrackPeer::NUM_COLUMNS - TrackPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	/**
	 * Clears out the collSchoolclasss collection (array).
	 *
	...
	/**
	 * Initializes the collSchoolclasss collection (array).
	 *
	 ...
	 * related Schoolclasss from storage. If this Track is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 * @return     array Schoolclass[]
	 * @throws     PropelException
	 */
	...
	public function countSchoolclasss(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		...
		if ($this->collSchoolclasss === null) {
			if ($this->isNew()) {
				...
				$count = SchoolclassPeer::doCount($criteria, false, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
	...
	public function addSchoolclass(Schoolclass $l)
	{
		...
		if (!in_array($l, $this->collSchoolclasss, true)) { // only add it if the **same** object is not already associated
			array_push($this->collSchoolclasss, $l);
			$l->setTrack($this);
		}
	}
