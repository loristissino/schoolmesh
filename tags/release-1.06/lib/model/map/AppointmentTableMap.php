...
class AppointmentTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addForeignKey('SCHOOLCLASS_ID', 'SchoolclassId', 'VARCHAR', 'schoolclass', 'ID', false, 5, null);
    ...
    $this->addRelation('StudentSyllabusItem', 'StudentSyllabusItem', RelationMap::ONE_TO_MANY, array('id' => 'appointment_id', ), 'CASCADE', 'CASCADE');
	} // buildRelations()
