...
<td style="text-align: right<?php if(!$resource->getIsMonetary()) echo "; color:gray" ?>" class='amount'><?php echo $resource->getProjResourceType()->getMeasurementUnit() ?></td>
<td style="text-align: right<?php if(!$resource->getIsMonetary()) echo "; color:gray" ?>" class='amount'><?php echo quantityvalue($resource->getQuantityEstimated()) ?></td>
<td style="text-align: right<?php if(!$resource->getIsMonetary()) echo "; color:gray" ?>" class='amount'><?php echo quantityvalue($resource->getQuantityApproved()) ?></td>
