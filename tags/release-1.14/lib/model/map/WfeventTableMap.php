...
/**
 * This class defines the structure of the 'wfevent' table.
 *
 *
 *
 ...
 */
class WfeventTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.WfeventTableMap';
	...
	{
	  // attributes
		$this->setName('wfevent');
		$this->setPhpName('Wfevent');
		$this->setClassname('Wfevent');
