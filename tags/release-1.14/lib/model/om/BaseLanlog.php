...
/**
 * Base class that represents a row from the 'lanlog' table.
 *
 * 
 *
...
abstract class BaseLanlog extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the workstation_id field.
	 * @var        int
	 */
	...
	/**
	 * The value for the os_used field.
	 * @var        string
	 */
	protected $os_used;
	...
	/**
	 * Initializes internal state of BaseLanlog object.
	 * @see        applyDefaults()
	 */
	...
	/**
	 * Get the [workstation_id] column value.
	 * 
	 * @return     int
	 */
	 ...
	 * @return     Lanlog The current object (for fluent API support)
	 */
	...
	/**
	 * Set the value of [workstation_id] column.
	 * 
	 * @param      int $v new value
	 * @return     Lanlog The current object (for fluent API support)
	 */
	...
	public function setIsOnline($v)
	{
		...
		if ($this->is_online !== $v || $this->isNew()) {
			$this->is_online = $v;
	...
	/**
	 * Set the value of [os_used] column.
	 * 
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 7; // 7 = LanlogPeer::NUM_COLUMNS - LanlogPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($isInsert) {
				...
				// symfony_timestampable behavior
				if (!$this->isColumnModified(LanlogPeer::CREATED_AT))
				{
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Lanlog (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Lanlog Clone of current object.
	 * @throws     PropelException
	 */
	...
	public function getsfGuardUser(PropelPDO $con = null)
	{
		if ($this->asfGuardUser === null && ($this->user_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->asfGuardUser->addLanlogs($this);
			 */
		}
	...
	/**
	 * Declares an association between this object and a Workstation object.
	 *
	 * @param      Workstation $v
	 * @return     Lanlog The current object (for fluent API support)
	 * @throws     PropelException
	...
	public function setWorkstation(Workstation $v = null)
	{
		...
		// Add binding for other direction of this n:n relationship.
		// If this object has already been added to the Workstation object, it will not be re-added.
		if ($v !== null) {
			$v->addLanlog($this);
		}
	...
	/**
	 * Get the associated Workstation object
	 *
	 * @param      PropelPDO Optional Connection object.
	 * @return     Workstation The associated Workstation object.
	 * @throws     PropelException
	 */
	public function getWorkstation(PropelPDO $con = null)
	{
		if ($this->aWorkstation === null && ($this->workstation_id !== null)) {
			$this->aWorkstation = WorkstationPeer::retrieveByPk($this->workstation_id);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aWorkstation->addLanlogs($this);
			 */
		}
