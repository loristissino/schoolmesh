...
/**
 * Base static class for performing query and update operations on the 'ticket_event' table.
 *
 * 
 *
...
abstract class BaseTicketEventPeer {
	...
	/**
	 * An identiy map to hold any loaded instances of TicketEvent objects.
	 * This must be public so that other peer classes can access this when hydrating from JOIN
	 * queries.
	 * @var        array TicketEvent[]
	 */
	 ...
	 * @param      string $column The column name for current table. (i.e. TicketEventPeer::COLUMN_NAME).
	 * @return     string
	 */
	 ...
	 *
	 * @param      TicketEvent $value A TicketEvent object.
	 ...
	 *
	 * @param      mixed $value A TicketEvent object or a primary key value.
	 */
	 ...
	 * @return     TicketEvent Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	/**
	 * Method to invalidate the instance pool of all tables related to ticket_event
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = TicketEventPeer::getOMClass(false);
	...
	public static function doCountJoinTicket(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(TicketEventPeer::TICKET_ID, TicketPeer::ID, $join_behavior);
	...
	public static function doCountJoinsfGuardUserRelatedByUserId(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(TicketEventPeer::USER_ID, sfGuardUserPeer::ID, $join_behavior);
	...
	/**
	 * Returns the number of rows matching criteria, joining the related sfGuardUserRelatedByAssigneeId table
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
	 * @param      PropelPDO $con
	...
	public static function doCountJoinsfGuardUserRelatedByAssigneeId(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(TicketEventPeer::ASSIGNEE_ID, sfGuardUserPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of TicketEvent objects pre-filled with their Ticket objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of TicketEvent objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 */
	...
	/**
	 * Selects a collection of TicketEvent objects pre-filled with their sfGuardUser objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of TicketEvent objects.
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinsfGuardUserRelatedByAssigneeId(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
	...
	/**
	 * Selects a collection of TicketEvent objects pre-filled with all related objects.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (TicketEvent) to the collection in $obj2 (Ticket)
				$obj2->addTicketEvent($obj1);
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (TicketEvent) to the collection in $obj3 (sfGuardUser)
			...
			if ($key4 !== null) {
				...
				// Add the $obj1 (TicketEvent) to the collection in $obj4 (sfGuardUser)
	...
	/**
	 * Selects a collection of TicketEvent objects pre-filled with all related objects except Ticket.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAllExceptTicket(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = TicketEventPeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (TicketEvent) to the collection in $obj2 (sfGuardUser)
				$obj2->addTicketEventRelatedByUserId($obj1);
				...
				// Add the $obj1 (TicketEvent) to the collection in $obj3 (sfGuardUser)
				$obj3->addTicketEventRelatedByAssigneeId($obj1);
	...
	/**
	 * Selects a collection of TicketEvent objects pre-filled with all related objects except sfGuardUserRelatedByUserId.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	/**
	 * Selects a collection of TicketEvent objects pre-filled with all related objects except sfGuardUserRelatedByAssigneeId.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinAllExceptsfGuardUserRelatedByAssigneeId(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
	...
	{
	  $dbMap = Propel::getDatabaseMap(BaseTicketEventPeer::DATABASE_NAME);
	  if (!$dbMap->hasTable(BaseTicketEventPeer::TABLE_NAME))
	  {
	    $dbMap->addTableObject(new TicketEventTableMap());
	  }
	}
	...
	{
		return $withPrefix ? TicketEventPeer::CLASS_DEFAULT : TicketEventPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a TicketEvent or Criteria object.
	 *
	 * @param      mixed $values Criteria or TicketEvent object containing data that is used to create the INSERT statement.
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from TicketEvent object
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a TicketEvent or Criteria object.
	 *
	 * @param      mixed $values Criteria or TicketEvent object containing data that is used to create the UPDATE statement.
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		} else { // $values is TicketEvent object
	...
	/**
	 * Method to DELETE all rows from the ticket_event table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			TicketEventPeer::clearRelatedInstancePool();
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
	...
	/**
	 * Method perform a DELETE on the database, given a TicketEvent or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or TicketEvent object or primary key or array of primary keys
	...
	/**
	 * Validates all modified columns of given TicketEvent object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      TicketEvent $obj The object to validate.
	...
	public static function doValidate(TicketEvent $obj, $cols = null)
	{
		...
		return BasePeer::doValidate(TicketEventPeer::DATABASE_NAME, TicketEventPeer::TABLE_NAME, $columns);
	}
...
//
BaseTicketEventPeer::buildTableMap();
