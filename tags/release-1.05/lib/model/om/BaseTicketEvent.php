...
/**
 * Base class that represents a row from the 'ticket_event' table.
 *
 * 
 *
...
abstract class BaseTicketEvent extends BaseObject  implements Persistent {
	 ...
	 * @return     TicketEvent The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 7; // 7 = TicketEventPeer::NUM_COLUMNS - TicketEventPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($isInsert) {
				...
				// symfony_timestampable behavior
				if (!$this->isColumnModified(TicketEventPeer::CREATED_AT))
				{
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of TicketEvent (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     TicketEvent Clone of current object.
	 * @throws     PropelException
	 */
	...
	public function getTicket(PropelPDO $con = null)
	{
		if ($this->aTicket === null && ($this->ticket_id !== null)) {
			$this->aTicket = TicketPeer::retrieveByPk($this->ticket_id);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aTicket->addTicketEvents($this);
			 */
		}
		return $this->aTicket;
	}
	...
	public function getsfGuardUserRelatedByUserId(PropelPDO $con = null)
	{
		if ($this->asfGuardUserRelatedByUserId === null && ($this->user_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->asfGuardUserRelatedByUserId->addTicketEventsRelatedByUserId($this);
			 */
		}
	...
	public function getsfGuardUserRelatedByAssigneeId(PropelPDO $con = null)
	{
		if ($this->asfGuardUserRelatedByAssigneeId === null && ($this->assignee_id !== null)) {
			$this->asfGuardUserRelatedByAssigneeId = sfGuardUserPeer::retrieveByPk($this->assignee_id);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->asfGuardUserRelatedByAssigneeId->addTicketEventsRelatedByAssigneeId($this);
			 */
		}
