...
/**
 * Base class that represents a row from the 'student_syllabus_item' table.
 *
 * 
 *
 * @package    lib.model.om
 */
abstract class BaseStudentSyllabusItem extends BaseObject  implements Persistent {
	...
	const PEER = 'StudentSyllabusItemPeer';
	 ...
	 * @return     StudentSyllabusItem The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = StudentSyllabusItemPeer::ID;
		}
	...
	public function setTermId($v)
	{
		...
		if ($this->term_id !== $v) {
			$this->term_id = $v;
			$this->modifiedColumns[] = StudentSyllabusItemPeer::TERM_ID;
		}
	...
	public function setAppointmentId($v)
	{
		...
		if ($this->appointment_id !== $v) {
			...
			$this->modifiedColumns[] = StudentSyllabusItemPeer::APPOINTMENT_ID;
		}
	...
	public function setUserId($v)
	{
		...
		if ($this->user_id !== $v) {
			$this->user_id = $v;
			$this->modifiedColumns[] = StudentSyllabusItemPeer::USER_ID;
		}
	...
	public function setSyllabusItemId($v)
	{
		...
		if ($this->syllabus_item_id !== $v) {
			...
			$this->modifiedColumns[] = StudentSyllabusItemPeer::SYLLABUS_ITEM_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->syllabus_item_id = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
			$this->resetModified();
			...
			return $startcol + 5; // 5 = StudentSyllabusItemPeer::NUM_COLUMNS - StudentSyllabusItemPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating StudentSyllabusItem object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = StudentSyllabusItemPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				StudentSyllabusItemPeer::doDelete($this, $con);
				$this->postDelete($con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				StudentSyllabusItemPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = StudentSyllabusItemPeer::doInsert($this, $con);
					...
					$affectedRows += StudentSyllabusItemPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = StudentSyllabusItemPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = StudentSyllabusItemPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = StudentSyllabusItemPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getTermId(),
			$keys[2] => $this->getAppointmentId(),
			$keys[3] => $this->getUserId(),
			$keys[4] => $this->getSyllabusItemId(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[4], $arr)) $this->setSyllabusItemId($arr[$keys[4]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(StudentSyllabusItemPeer::ID)) $criteria->add(StudentSyllabusItemPeer::ID, $this->id);
		if ($this->isColumnModified(StudentSyllabusItemPeer::TERM_ID)) $criteria->add(StudentSyllabusItemPeer::TERM_ID, $this->term_id);
		if ($this->isColumnModified(StudentSyllabusItemPeer::APPOINTMENT_ID)) $criteria->add(StudentSyllabusItemPeer::APPOINTMENT_ID, $this->appointment_id);
		if ($this->isColumnModified(StudentSyllabusItemPeer::USER_ID)) $criteria->add(StudentSyllabusItemPeer::USER_ID, $this->user_id);
		if ($this->isColumnModified(StudentSyllabusItemPeer::SYLLABUS_ITEM_ID)) $criteria->add(StudentSyllabusItemPeer::SYLLABUS_ITEM_ID, $this->syllabus_item_id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(StudentSyllabusItemPeer::ID, $this->id);
		$criteria->add(StudentSyllabusItemPeer::APPOINTMENT_ID, $this->appointment_id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of StudentSyllabusItem (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     StudentSyllabusItem Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     StudentSyllabusItemPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new StudentSyllabusItemPeer();
		}
		return self::$peer;
	}
	...
	public function getTerm(PropelPDO $con = null)
	{
		if ($this->aTerm === null && (($this->term_id !== "" && $this->term_id !== null))) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aTerm->addStudentSyllabusItems($this);
			 */
		}
		return $this->aTerm;
	}
	...
	public function getAppointment(PropelPDO $con = null)
	{
		if ($this->aAppointment === null && ($this->appointment_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aAppointment->addStudentSyllabusItems($this);
			 */
		}
	...
	public function getsfGuardUser(PropelPDO $con = null)
	{
		if ($this->asfGuardUser === null && ($this->user_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->asfGuardUser->addStudentSyllabusItems($this);
			 */
		}
	...
	public function getSyllabusItem(PropelPDO $con = null)
	{
		if ($this->aSyllabusItem === null && ($this->syllabus_item_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aSyllabusItem->addStudentSyllabusItems($this);
			 */
		}
