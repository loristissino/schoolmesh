...
/**
 * Base class that represents a row from the 'informativecontent' table.
 *
 * 
 *
 * @package    lib.model.om
 */
abstract class BaseInformativecontent extends BaseObject  implements Persistent {
	...
	const PEER = 'InformativecontentPeer';
	 ...
	 * @return     Informativecontent The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = InformativecontentPeer::ID;
		}
	...
	public function setShortcut($v)
	{
		...
		if ($this->shortcut !== $v) {
			$this->shortcut = $v;
			$this->modifiedColumns[] = InformativecontentPeer::SHORTCUT;
		}
	...
	public function setDescription($v)
	{
		...
		if ($this->description !== $v) {
			$this->description = $v;
			$this->modifiedColumns[] = InformativecontentPeer::DESCRIPTION;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = InformativecontentPeer::NUM_COLUMNS - InformativecontentPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating Informativecontent object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = InformativecontentPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				InformativecontentPeer::doDelete($this, $con);
				$this->postDelete($con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				InformativecontentPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = InformativecontentPeer::doInsert($this, $con);
					...
					$affectedRows += InformativecontentPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = InformativecontentPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = InformativecontentPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = InformativecontentPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(InformativecontentPeer::ID)) $criteria->add(InformativecontentPeer::ID, $this->id);
		if ($this->isColumnModified(InformativecontentPeer::SHORTCUT)) $criteria->add(InformativecontentPeer::SHORTCUT, $this->shortcut);
		if ($this->isColumnModified(InformativecontentPeer::DESCRIPTION)) $criteria->add(InformativecontentPeer::DESCRIPTION, $this->description);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(InformativecontentPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Informativecontent (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Informativecontent Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     InformativecontentPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new InformativecontentPeer();
		}
		return self::$peer;
	}
	 ...
	 * Otherwise if this Informativecontent has previously been saved, it will retrieve
	 * related Consents from storage. If this Informativecontent is new, it will return
		...
		if ($this->collConsents === null) {
			if ($this->isNew()) {
			   $this->collConsents = array();
				...
				$criteria->add(ConsentPeer::INFORMATIVECONTENT_ID, $this->id);
	 ...
	 * Otherwise if this Informativecontent is new, it will return
	 * an empty collection; or if this Informativecontent has previously
	 * been saved, it will retrieve related Consents from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in Informativecontent.
	 */
	public function getConsentsJoinsfGuardUser($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(InformativecontentPeer::DATABASE_NAME);
		}
		...
		if ($this->collConsents === null) {
			if ($this->isNew()) {
				...
				$this->collConsents = ConsentPeer::doSelectJoinsfGuardUser($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
