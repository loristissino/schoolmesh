...
<?php foreach($deadlines as $deadline): ?>
    ...
    <?php if ($project->getState()>Workflow::PROJ_SUBMITTED): // already approved ?>
      <ul>
    ...
    <?php else: // just submitted or in draft ?>
      (<?php echo Generic::datetime($deadline->getOriginalDeadlineDate('U'), $sf_context->getRawValue()) ?>)
