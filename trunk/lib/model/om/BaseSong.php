...
abstract class BaseSong extends BaseObject  implements Persistent {
  ...
  const PEER = 'SongPeer';
	...
	public function setTitle($v)
	{
		...
		if ($this->title !== $v) {
			$this->title = $v;
			$this->modifiedColumns[] = SongPeer::TITLE;
		}
	...
	public function setAuthor($v)
	{
		...
		if ($this->author !== $v) {
			$this->author = $v;
			$this->modifiedColumns[] = SongPeer::AUTHOR;
		}
		...
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			...
			if ($this->isNew() ) {
				$this->modifiedColumns[] = SongPeer::ID;
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = SongPeer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setId($pk);  
					$this->setNew(false);
				} else {
					$affectedRows += SongPeer::doUpdate($this, $con);
				}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(SongPeer::TITLE)) $criteria->add(SongPeer::TITLE, $this->title);
		if ($this->isColumnModified(SongPeer::AUTHOR)) $criteria->add(SongPeer::AUTHOR, $this->author);
