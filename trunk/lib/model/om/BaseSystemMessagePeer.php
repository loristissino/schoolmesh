...
/**
 * Base static class for performing query and update operations on the 'system_message' table.
 *
 * 
 *
...
abstract class BaseSystemMessagePeer {
	...
	const OM_CLASS = 'SystemMessage';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'lib.model.SystemMessage';

	/** the related TableMap class for this table */
	const TM_CLASS = 'SystemMessageTableMap';
	...
	/**
	 * An identiy map to hold any loaded instances of SystemMessage objects.
	 * This must be public so that other peer classes can access this when hydrating from JOIN
	 * queries.
	 * @var        array SystemMessage[]
	 */
	 ...
	 * @param      string $column The column name for current table. (i.e. SystemMessagePeer::COLUMN_NAME).
	 * @return     string
	 */
	 ...
	 *
	 * @param      SystemMessage $value A SystemMessage object.
	 ...
	 *
	 * @param      mixed $value A SystemMessage object or a primary key value.
	 */
	 ...
	 * @return     SystemMessage Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	/**
	 * Method to invalidate the instance pool of all tables related to system_message
	 * by a foreign key with ON DELETE CASCADE
	 */
	public static function clearRelatedInstancePool()
	{
		// invalidate objects in SystemMessageI18nPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	{
	  $dbMap = Propel::getDatabaseMap(BaseSystemMessagePeer::DATABASE_NAME);
	  if (!$dbMap->hasTable(BaseSystemMessagePeer::TABLE_NAME))
	  {
	    $dbMap->addTableObject(new SystemMessageTableMap());
	  }
	}
	...
	{
		return $withPrefix ? SystemMessagePeer::CLASS_DEFAULT : SystemMessagePeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a SystemMessage or Criteria object.
	 *
	 * @param      mixed $values Criteria or SystemMessage object containing data that is used to create the INSERT statement.
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from SystemMessage object
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a SystemMessage or Criteria object.
	 *
	 * @param      mixed $values Criteria or SystemMessage object containing data that is used to create the UPDATE statement.
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		} else { // $values is SystemMessage object
	...
	/**
	 * Method to DELETE all rows from the system_message table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			SystemMessagePeer::clearRelatedInstancePool();
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
	...
	/**
	 * Method perform a DELETE on the database, given a SystemMessage or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or SystemMessage object or primary key or array of primary keys
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof SystemMessage) { // it's a model object
	...
	/**
	 * Validates all modified columns of given SystemMessage object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      SystemMessage $obj The object to validate.
	...
	public static function doValidate(SystemMessage $obj, $cols = null)
	{
		...
		return BasePeer::doValidate(SystemMessagePeer::DATABASE_NAME, SystemMessagePeer::TABLE_NAME, $columns);
	}
	...
	/**
	 * Selects a collection of {@link SystemMessage} objects with a {@link SystemMessageI18n} translation populated.
	 *
	 * @param Criteria  $criteria
	...
	static public function doSelectWithI18n(Criteria $criteria, $culture = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
	  ...
	  $criteria->addJoin(SystemMessagePeer::ID, SystemMessageI18nPeer::ID, $join_behavior);
	  ...
	  $stmt = BasePeer::doSelect($criteria, $con);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key1 = SystemMessagePeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj1 = SystemMessagePeer::getInstanceFromPool($key1))) {
				// We no longer rehydrate the object, since this can cause data loss.
	  		// See http://propel.phpdb.org/trac/ticket/509
	  		// $obj1->hydrate($row, 0, true); // rehydrate
				...
				$obj1 = new $cls();
				$obj1->hydrate($row);
	      SystemMessagePeer::addInstanceToPool($obj1, $key1);
			} // if $obj1 already loaded
	
			$key2 = SystemMessageI18nPeer::getPrimaryKeyHashFromRow($row, $startcol);
			if ($key2 !== null) {
				$obj2 = SystemMessageI18nPeer::getInstanceFromPool($key2);
				if (!$obj2) {
					$cls = SystemMessageI18nPeer::getOMClass(false);
					$obj2 = new $cls();
					$obj2->hydrate($row, $startcol);
					SystemMessageI18nPeer::addInstanceToPool($obj2, $key2);
...
} // BaseSystemMessagePeer

// This is the static code needed to register the TableMap for this table with the main Propel class.
//
BaseSystemMessagePeer::buildTableMap();
