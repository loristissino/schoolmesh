...
/**
 * Base class that represents a row from the 'enrolment' table.
 *
 * 
 *
...
abstract class BaseEnrolment extends BaseObject  implements Persistent {
	 ...
	 * @return     Enrolment The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 8; // 8 = EnrolmentPeer::NUM_COLUMNS - EnrolmentPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($isInsert) {
				...
				// symfony_timestampable behavior
				if (!$this->isColumnModified(EnrolmentPeer::CREATED_AT))
				{
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Enrolment (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Enrolment Clone of current object.
	 * @throws     PropelException
	 */
	...
	public function getsfGuardUser(PropelPDO $con = null)
	{
		if ($this->asfGuardUser === null && ($this->user_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->asfGuardUser->addEnrolments($this);
			 */
		}
	...
	public function getSchoolclass(PropelPDO $con = null)
	{
		if ($this->aSchoolclass === null && (($this->schoolclass_id !== "" && $this->schoolclass_id !== null))) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aSchoolclass->addEnrolments($this);
			 */
		}
