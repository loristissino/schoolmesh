...
/**
 * Base static class for performing query and update operations on the 'wpmodule' table.
 *
 * 
 *
...
abstract class BaseWpmodulePeer {
	...
	const OM_CLASS = 'Wpmodule';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'lib.model.Wpmodule';

	/** the related TableMap class for this table */
	const TM_CLASS = 'WpmoduleTableMap';
	...
	/** the column name for the HOURS_USED field */
	...
	/**
	 * An identiy map to hold any loaded instances of Wpmodule objects.
	 ...
	 * @param      string $column The column name for current table. (i.e. WpmodulePeer::COLUMN_NAME).
	 * @return     string
	 */
	 ...
	 *
	 * @param      Wpmodule $value A Wpmodule object.
	 ...
	 *
	 * @param      mixed $value A Wpmodule object or a primary key value.
	 */
	 ...
	 * @return     Wpmodule Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	/**
	 * Method to invalidate the instance pool of all tables related to wpmodule
	 * by a foreign key with ON DELETE CASCADE
	 */
	public static function clearRelatedInstancePool()
	{
		// invalidate objects in WpitemGroupPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	public static function doCountJoinsfGuardUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(WpmodulePeer::USER_ID, sfGuardUserPeer::ID, $join_behavior);
	...
	public static function doCountJoinAppointment(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(WpmodulePeer::APPOINTMENT_ID, AppointmentPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Wpmodule objects pre-filled with their sfGuardUser objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of Wpmodule objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 */
	...
	/**
	 * Selects a collection of Wpmodule objects pre-filled with their Appointment objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of Wpmodule objects.
	...
	/**
	 * Selects a collection of Wpmodule objects pre-filled with all related objects.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Wpmodule) to the collection in $obj2 (sfGuardUser)
				$obj2->addWpmodule($obj1);
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (Wpmodule) to the collection in $obj3 (Appointment)
	...
	/**
	 * Selects a collection of Wpmodule objects pre-filled with all related objects except sfGuardUser.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAllExceptsfGuardUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = WpmodulePeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (Wpmodule) to the collection in $obj2 (Appointment)
				$obj2->addWpmodule($obj1);
	...
	/**
	 * Selects a collection of Wpmodule objects pre-filled with all related objects except Appointment.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	{
	  $dbMap = Propel::getDatabaseMap(BaseWpmodulePeer::DATABASE_NAME);
	  if (!$dbMap->hasTable(BaseWpmodulePeer::TABLE_NAME))
	  {
	    $dbMap->addTableObject(new WpmoduleTableMap());
	  }
	}
	...
	{
		return $withPrefix ? WpmodulePeer::CLASS_DEFAULT : WpmodulePeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a Wpmodule or Criteria object.
	 *
	 * @param      mixed $values Criteria or Wpmodule object containing data that is used to create the INSERT statement.
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from Wpmodule object
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a Wpmodule or Criteria object.
	 *
	 * @param      mixed $values Criteria or Wpmodule object containing data that is used to create the UPDATE statement.
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		} else { // $values is Wpmodule object
	...
	/**
	 * Method to DELETE all rows from the wpmodule table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			WpmodulePeer::clearRelatedInstancePool();
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
	...
	/**
	 * Method perform a DELETE on the database, given a Wpmodule or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or Wpmodule object or primary key or array of primary keys
	...
	/**
	 * Validates all modified columns of given Wpmodule object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      Wpmodule $obj The object to validate.
	...
	public static function doValidate(Wpmodule $obj, $cols = null)
	{
		...
		return BasePeer::doValidate(WpmodulePeer::DATABASE_NAME, WpmodulePeer::TABLE_NAME, $columns);
	}
...
//
BaseWpmodulePeer::buildTableMap();
