...
/**
 * Base class that represents a row from the 'recuperation_hint' table.
 *
 * 
 *
 * @package    lib.model.om
 */
abstract class BaseRecuperationHint extends BaseObject  implements Persistent {
	...
	const PEER = 'RecuperationHintPeer';
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = RecuperationHintPeer::ID;
		}
	...
	public function setUserId($v)
	{
		...
		if ($this->user_id !== $v) {
			$this->user_id = $v;
			$this->modifiedColumns[] = RecuperationHintPeer::USER_ID;
		}
	...
	public function setContent($v)
	{
		...
		if ($this->content !== $v) {
			$this->content = $v;
			$this->modifiedColumns[] = RecuperationHintPeer::CONTENT;
		}
	...
	public function setRank($v)
	{
		...
		if ($this->rank !== $v) {
			$this->rank = $v;
			$this->modifiedColumns[] = RecuperationHintPeer::RANK;
		}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = RecuperationHintPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				RecuperationHintPeer::doDelete($this, $con);
				$this->postDelete($con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				RecuperationHintPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = RecuperationHintPeer::doInsert($this, $con);
					...
					$affectedRows += RecuperationHintPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = RecuperationHintPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = RecuperationHintPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = RecuperationHintPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(RecuperationHintPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of RecuperationHint (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     RecuperationHint Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     RecuperationHintPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new RecuperationHintPeer();
		}
		return self::$peer;
	}
	...
	public function getsfGuardUser(PropelPDO $con = null)
	{
		if ($this->asfGuardUser === null && ($this->user_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->asfGuardUser->addRecuperationHints($this);
			 */
		}
	 ...
	 * Otherwise if this RecuperationHint has previously been saved, it will retrieve
	 * related StudentHints from storage. If this RecuperationHint is new, it will return
		...
		if ($this->collStudentHints === null) {
			if ($this->isNew()) {
			   $this->collStudentHints = array();
				...
				$criteria->add(StudentHintPeer::RECUPERATION_HINT_ID, $this->id);
	 ...
	 * Otherwise if this RecuperationHint is new, it will return
	 * an empty collection; or if this RecuperationHint has previously
	 * been saved, it will retrieve related StudentHints from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in RecuperationHint.
	 */
