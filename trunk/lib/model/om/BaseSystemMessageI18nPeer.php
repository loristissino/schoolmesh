...
/**
 * Base static class for performing query and update operations on the 'system_message_i18n' table.
 *
 * 
 *
...
abstract class BaseSystemMessageI18nPeer {
	...
	const OM_CLASS = 'SystemMessageI18n';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'lib.model.SystemMessageI18n';

	/** the related TableMap class for this table */
	const TM_CLASS = 'SystemMessageI18nTableMap';
	...
	/**
	 * An identiy map to hold any loaded instances of SystemMessageI18n objects.
	 * This must be public so that other peer classes can access this when hydrating from JOIN
	 * queries.
	 * @var        array SystemMessageI18n[]
	 */
	 ...
	 * @param      string $column The column name for current table. (i.e. SystemMessageI18nPeer::COLUMN_NAME).
	 * @return     string
	 */
	 ...
	 *
	 * @param      SystemMessageI18n $value A SystemMessageI18n object.
	 ...
	 *
	 * @param      mixed $value A SystemMessageI18n object or a primary key value.
	 */
	 ...
	 * @return     SystemMessageI18n Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	/**
	 * Method to invalidate the instance pool of all tables related to system_message_i18n
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = SystemMessageI18nPeer::getOMClass(false);
	...
	/**
	 * Returns the number of rows matching criteria, joining the related SystemMessage table
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
	 * @param      PropelPDO $con
	...
	public static function doCountJoinSystemMessage(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(SystemMessageI18nPeer::ID, SystemMessagePeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of SystemMessageI18n objects pre-filled with their SystemMessage objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of SystemMessageI18n objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinSystemMessage(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				if (!$obj2) {
					...
					$cls = SystemMessagePeer::getOMClass(false);
	...
	/**
	 * Selects a collection of SystemMessageI18n objects pre-filled with all related objects.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			// Add objects for joined SystemMessage rows
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (SystemMessageI18n) to the collection in $obj2 (SystemMessage)
				$obj2->addSystemMessageI18n($obj1);
	...
	{
	  $dbMap = Propel::getDatabaseMap(BaseSystemMessageI18nPeer::DATABASE_NAME);
	  if (!$dbMap->hasTable(BaseSystemMessageI18nPeer::TABLE_NAME))
	  {
	    $dbMap->addTableObject(new SystemMessageI18nTableMap());
	  }
	}
	...
	{
		return $withPrefix ? SystemMessageI18nPeer::CLASS_DEFAULT : SystemMessageI18nPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a SystemMessageI18n or Criteria object.
	 *
	 * @param      mixed $values Criteria or SystemMessageI18n object containing data that is used to create the INSERT statement.
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from SystemMessageI18n object
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a SystemMessageI18n or Criteria object.
	 *
	 * @param      mixed $values Criteria or SystemMessageI18n object containing data that is used to create the UPDATE statement.
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		} else { // $values is SystemMessageI18n object
	...
	/**
	 * Method to DELETE all rows from the system_message_i18n table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			SystemMessageI18nPeer::clearRelatedInstancePool();
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
	...
	/**
	 * Method perform a DELETE on the database, given a SystemMessageI18n or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or SystemMessageI18n object or primary key or array of primary keys
	...
	/**
	 * Validates all modified columns of given SystemMessageI18n object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      SystemMessageI18n $obj The object to validate.
	...
	public static function doValidate(SystemMessageI18n $obj, $cols = null)
	{
		...
		return BasePeer::doValidate(SystemMessageI18nPeer::DATABASE_NAME, SystemMessageI18nPeer::TABLE_NAME, $columns);
	}
...
} // BaseSystemMessageI18nPeer

// This is the static code needed to register the TableMap for this table with the main Propel class.
//
BaseSystemMessageI18nPeer::buildTableMap();
