...
/**
 * Base static class for performing query and update operations on the 'wptool_item' table.
 *
 * 
 *
...
abstract class BaseWptoolItemPeer {
	...
	/**
	 * An identiy map to hold any loaded instances of WptoolItem objects.
	 * This must be public so that other peer classes can access this when hydrating from JOIN
	 * queries.
	 * @var        array WptoolItem[]
	 */
	 ...
	 * @param      string $column The column name for current table. (i.e. WptoolItemPeer::COLUMN_NAME).
	 * @return     string
	 */
	 ...
	 *
	 * @param      WptoolItem $value A WptoolItem object.
	 ...
	 *
	 * @param      mixed $value A WptoolItem object or a primary key value.
	 */
	 ...
	 * @return     WptoolItem Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	/**
	 * Method to invalidate the instance pool of all tables related to wptool_item
	...
	/**
	 * Returns the number of rows matching criteria, joining the related WptoolItemType table
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
	 * @param      PropelPDO $con
	...
	public static function doCountJoinWptoolItemType(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(WptoolItemPeer::WPTOOL_ITEM_TYPE_ID, WptoolItemTypePeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of WptoolItem objects pre-filled with their WptoolItemType objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of WptoolItem objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinWptoolItemType(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
	...
	/**
	 * Selects a collection of WptoolItem objects pre-filled with all related objects.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			// Add objects for joined WptoolItemType rows
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (WptoolItem) to the collection in $obj2 (WptoolItemType)
				$obj2->addWptoolItem($obj1);
	...
	{
	  $dbMap = Propel::getDatabaseMap(BaseWptoolItemPeer::DATABASE_NAME);
	  if (!$dbMap->hasTable(BaseWptoolItemPeer::TABLE_NAME))
	  {
	    $dbMap->addTableObject(new WptoolItemTableMap());
	  }
	}
	...
	{
		return $withPrefix ? WptoolItemPeer::CLASS_DEFAULT : WptoolItemPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a WptoolItem or Criteria object.
	 *
	 * @param      mixed $values Criteria or WptoolItem object containing data that is used to create the INSERT statement.
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from WptoolItem object
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a WptoolItem or Criteria object.
	 *
	 * @param      mixed $values Criteria or WptoolItem object containing data that is used to create the UPDATE statement.
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		} else { // $values is WptoolItem object
	...
	/**
	 * Method to DELETE all rows from the wptool_item table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			WptoolItemPeer::clearRelatedInstancePool();
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
	...
	/**
	 * Method perform a DELETE on the database, given a WptoolItem or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or WptoolItem object or primary key or array of primary keys
	...
	/**
	 * Validates all modified columns of given WptoolItem object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      WptoolItem $obj The object to validate.
	...
	public static function doValidate(WptoolItem $obj, $cols = null)
	{
		...
		return BasePeer::doValidate(WptoolItemPeer::DATABASE_NAME, WptoolItemPeer::TABLE_NAME, $columns);
	}
...
//
BaseWptoolItemPeer::buildTableMap();
