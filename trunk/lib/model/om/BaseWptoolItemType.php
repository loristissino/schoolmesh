...
/**
 * Base class that represents a row from the 'wptool_item_type' table.
 *
 * 
 *
...
abstract class BaseWptoolItemType extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the max_selected field.
	 * @var        int
	 */
	...
	/**
	 * @var        Criteria The criteria used to select the current contents of collWptoolItems.
	 */
	...
	/**
	 * Initializes internal state of BaseWptoolItemType object.
	 * @see        applyDefaults()
	 */
	...
	/**
	 * Get the [min_selected] column value.
	 * 
	 * @return     int
	 */
	...
	/**
	 * Get the [max_selected] column value.
	 * 
	 * @return     int
	 */
	 ...
	 * @return     WptoolItemType The current object (for fluent API support)
	 */
	public function setMinSelected($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->min_selected !== $v) {
			$this->min_selected = $v;
			$this->modifiedColumns[] = WptoolItemTypePeer::MIN_SELECTED;
		}
	...
	/**
	 * Set the value of [max_selected] column.
	 * 
	 * @param      int $v new value
	 * @return     WptoolItemType The current object (for fluent API support)
	 */
	public function setMaxSelected($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->max_selected !== $v) {
			$this->max_selected = $v;
			$this->modifiedColumns[] = WptoolItemTypePeer::MAX_SELECTED;
		}
	...
	public function setGradeMin($v)
	{
		...
		if ($this->grade_min !== $v || $this->isNew()) {
			$this->grade_min = $v;
			$this->modifiedColumns[] = WptoolItemTypePeer::GRADE_MIN;
		}
	...
	public function setGradeMax($v)
	{
		...
		if ($this->grade_max !== $v || $this->isNew()) {
			$this->grade_max = $v;
			$this->modifiedColumns[] = WptoolItemTypePeer::GRADE_MAX;
		}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(WptoolItemTypePeer::GRADE_MAX)) $criteria->add(WptoolItemTypePeer::GRADE_MAX, $this->grade_max);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of WptoolItemType (or compatible) type.
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setMaxSelected($this->max_selected);
		...
		if ($deepCopy) {
			...
			foreach ($this->getWptoolItems() as $relObj) {
				if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
					$copyObj->addWptoolItem($relObj->copy($deepCopy));
				}
			}
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     WptoolItemType Clone of current object.
	 * @throws     PropelException
	 */
	...
	/**
	 * Clears out the collWptoolItems collection (array).
	 *
	...
	{
		$this->collWptoolItems = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collWptoolItems collection (array).
	 *
	 * By default this just sets the collWptoolItems collection to an empty array (like clearcollWptoolItems());
	...
	/**
	 * Gets an array of WptoolItem objects which contain a foreign key that references this object.
	 *
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this WptoolItemType has previously been saved, it will retrieve
	 * related WptoolItems from storage. If this WptoolItemType is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 * @return     array WptoolItem[]
	 * @throws     PropelException
	 */
	...
	/**
	 * Returns the number of related WptoolItem objects.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      PropelPDO $con
	 * @return     int Count of related WptoolItem objects.
	 * @throws     PropelException
	 */
	public function countWptoolItems(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		...
		if ($this->collWptoolItems === null) {
			if ($this->isNew()) {
				...
				$count = WptoolItemPeer::doCount($criteria, false, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
	...
	/**
	 * Method called to associate a WptoolItem object to this object
	 * through the WptoolItem foreign key attribute.
	 *
	 * @param      WptoolItem $l WptoolItem
	 * @return     void
	 * @throws     PropelException
	 */
	public function addWptoolItem(WptoolItem $l)
	{
		...
		if (!in_array($l, $this->collWptoolItems, true)) { // only add it if the **same** object is not already associated
			array_push($this->collWptoolItems, $l);
