...
/**
 * Base class that represents a row from the 'account_type' table.
 *
 * 
 *
...
abstract class BaseAccountType extends BaseObject  implements Persistent {
	 ...
	 * @return     AccountType The current object (for fluent API support)
	 */
	...
	/**
	 * Set the value of [is_external] column.
	 * 
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 5; // 5 = AccountTypePeer::NUM_COLUMNS - AccountTypePeer::NUM_LAZY_LOAD_COLUMNS).
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of AccountType (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     AccountType Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 * Otherwise if this AccountType has previously been saved, it will retrieve
	 * related Accounts from storage. If this AccountType is new, it will return
	 ...
	 * Otherwise if this AccountType is new, it will return
	 * an empty collection; or if this AccountType has previously
	 * been saved, it will retrieve related Accounts from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in AccountType.
	 */
