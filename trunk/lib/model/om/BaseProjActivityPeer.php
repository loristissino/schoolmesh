...
/**
 * Base static class for performing query and update operations on the 'proj_activity' table.
 *
 * 
 *
 * @package    lib.model.om
 */
abstract class BaseProjActivityPeer {

	/** the default database name for this class */
	const DATABASE_NAME = 'propel';

	/** the table name for this class */
	const TABLE_NAME = 'proj_activity';

	/** the related Propel class for this table */
	const OM_CLASS = 'ProjActivity';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'lib.model.ProjActivity';
	 ...
	 * @param      string $column The column name for current table. (i.e. ProjActivityPeer::COLUMN_NAME).
	 * @return     string
	 */
	public static function alias($alias, $column)
	{
		return str_replace(ProjActivityPeer::TABLE_NAME.'.', $alias.'.', $column);
	}
	...
	public static function doSelectOne(Criteria $criteria, PropelPDO $con = null)
	{
		...
		$critcopy->setLimit(1);
		$objects = ProjActivityPeer::doSelect($critcopy, $con);
		if ($objects) {
			return $objects[0];
		}
		return null;
	...
	{
		return ProjActivityPeer::populateObjects(ProjActivityPeer::doSelectStmt($criteria, $con));
	}
	/**
	 ...
	 *
	 * @param      ProjActivity $value A ProjActivity object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(ProjActivity $obj, $key = null)
	{
	 ...
	 *
	 * @param      mixed $value A ProjActivity object or a primary key value.
	 */
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof ProjActivity) {
				$key = (string) $value->getId();
			} elseif (is_scalar($value)) {
				// assume we've been passed a primary key
				$key = (string) $value;
			} else {
				$e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or ProjActivity object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	 ...
	 * @return     ProjActivity Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	/**
	 * Method to invalidate the instance pool of all tables related to proj_activity
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key = ProjActivityPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj = ProjActivityPeer::getInstanceFromPool($key))) {
				...
				$obj->hydrate($row);
				$results[] = $obj;
				ProjActivityPeer::addInstanceToPool($obj, $key);
			} // if key exists
		}
		$stmt->closeCursor();
		return $results;
	...
	/**
	 * Selects a collection of ProjActivity objects pre-filled with all related objects.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	{
	  $dbMap = Propel::getDatabaseMap(BaseProjActivityPeer::DATABASE_NAME);
	  if (!$dbMap->hasTable(BaseProjActivityPeer::TABLE_NAME))
	  {
	    $dbMap->addTableObject(new ProjActivityTableMap());
	  }
	}
	...
	{
		return $withPrefix ? ProjActivityPeer::CLASS_DEFAULT : ProjActivityPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a ProjActivity or Criteria object.
	 *
	 * @param      mixed $values Criteria or ProjActivity object containing data that is used to create the INSERT statement.
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from ProjActivity object
		}

		if ($criteria->containsKey(ProjActivityPeer::ID) && $criteria->keyContainsValue(ProjActivityPeer::ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.ProjActivityPeer::ID.')');
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a ProjActivity or Criteria object.
	 *
	 * @param      mixed $values Criteria or ProjActivity object containing data that is used to create the UPDATE statement.
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(ProjActivityPeer::ID);
			$selectCriteria->add(ProjActivityPeer::ID, $criteria->remove(ProjActivityPeer::ID), $comparison);

		} else { // $values is ProjActivity object
	...
	/**
	 * Method to DELETE all rows from the proj_activity table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += BasePeer::doDeleteAll(ProjActivityPeer::TABLE_NAME, $con);
			// Because this db requires some delete cascade/set null emulation, we have to
			// clear the cached instance *after* the emulation has happened (since
			// instances get re-added by the select statement contained therein).
			ProjActivityPeer::clearInstancePool();
			ProjActivityPeer::clearRelatedInstancePool();
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
	...
	/**
	 * Method perform a DELETE on the database, given a ProjActivity or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or ProjActivity object or primary key or array of primary keys
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof ProjActivity) { // it's a model object
			// invalidate the cache for this single object
			ProjActivityPeer::removeInstanceFromPool($values);
			// create criteria based on pk values
			$criteria = $values->buildPkeyCriteria();
		} else { // it's a primary key, or an array of pks
			$criteria = new Criteria(self::DATABASE_NAME);
			$criteria->add(ProjActivityPeer::ID, (array) $values, Criteria::IN);
			// invalidate the cache for this object(s)
			foreach ((array) $values as $singleval) {
				ProjActivityPeer::removeInstanceFromPool($singleval);
			}
		}
	...
	/**
	 * Validates all modified columns of given ProjActivity object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      ProjActivity $obj The object to validate.
	 * @param      mixed $cols Column name or array of column names.
	 *
	 * @return     mixed TRUE if all columns are valid or the error message of the first invalid column.
	 */
	public static function doValidate(ProjActivity $obj, $cols = null)
	{
		$columns = array();

		if ($cols) {
			$dbMap = Propel::getDatabaseMap(ProjActivityPeer::DATABASE_NAME);
			$tableMap = $dbMap->getTable(ProjActivityPeer::TABLE_NAME);
		...
		return BasePeer::doValidate(ProjActivityPeer::DATABASE_NAME, ProjActivityPeer::TABLE_NAME, $columns);
	}
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		if (null !== ($obj = ProjActivityPeer::getInstanceFromPool((string) $pk))) {
			return $obj;
		}
		...
		$criteria->add(ProjActivityPeer::ID, $pk);

		$v = ProjActivityPeer::doSelect($criteria, $con);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(ProjActivityPeer::DATABASE_NAME);
			$criteria->add(ProjActivityPeer::ID, $pks, Criteria::IN);
			$objs = ProjActivityPeer::doSelect($criteria, $con);
		}
		return $objs;
	}
...
} // BaseProjActivityPeer

// This is the static code needed to register the TableMap for this table with the main Propel class.
//
BaseProjActivityPeer::buildTableMap();
