...
/**
 * Base class that represents a row from the 'wpinfo' table.
 *
 * 
 *
...
abstract class BaseWpinfo extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the wpinfo_type_id field.
	 * @var        int
	 */
	...
	/**
	 * Get the [wpinfo_type_id] column value.
	 * 
	 * @return     int
	 */
	 ...
	 * @return     Wpinfo The current object (for fluent API support)
	 */
	...
	/**
	 * Set the value of [wpinfo_type_id] column.
	 * 
	 * @param      int $v new value
	 * @return     Wpinfo The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 5; // 5 = WpinfoPeer::NUM_COLUMNS - WpinfoPeer::NUM_LAZY_LOAD_COLUMNS).
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Wpinfo (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Wpinfo Clone of current object.
	 * @throws     PropelException
	 */
	...
	public function getAppointment(PropelPDO $con = null)
	{
		if ($this->aAppointment === null && ($this->appointment_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aAppointment->addWpinfos($this);
			 */
		}
	...
	/**
	 * Declares an association between this object and a WpinfoType object.
	 *
	 * @param      WpinfoType $v
	 * @return     Wpinfo The current object (for fluent API support)
	 * @throws     PropelException
	...
	public function setWpinfoType(WpinfoType $v = null)
	{
		...
		// Add binding for other direction of this n:n relationship.
		// If this object has already been added to the WpinfoType object, it will not be re-added.
		if ($v !== null) {
			$v->addWpinfo($this);
		}
	...
	/**
	 * Get the associated WpinfoType object
	 *
	 * @param      PropelPDO Optional Connection object.
	 * @return     WpinfoType The associated WpinfoType object.
	 * @throws     PropelException
	 */
	public function getWpinfoType(PropelPDO $con = null)
	{
		if ($this->aWpinfoType === null && ($this->wpinfo_type_id !== null)) {
			$this->aWpinfoType = WpinfoTypePeer::retrieveByPk($this->wpinfo_type_id);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aWpinfoType->addWpinfos($this);
			 */
		}
