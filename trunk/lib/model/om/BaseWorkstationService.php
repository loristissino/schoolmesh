...
/**
 * Base class that represents a row from the 'workstation_service' table.
 *
 * 
 *
...
abstract class BaseWorkstationService extends BaseObject  implements Persistent {
	 ...
	 * @return     WorkstationService The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = WorkstationServicePeer::NUM_COLUMNS - WorkstationServicePeer::NUM_LAZY_LOAD_COLUMNS).
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of WorkstationService (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     WorkstationService Clone of current object.
	 * @throws     PropelException
	 */
	...
	public function getWorkstation(PropelPDO $con = null)
	{
		if ($this->aWorkstation === null && ($this->workstation_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aWorkstation->addWorkstationServices($this);
			 */
		}
	...
	public function getService(PropelPDO $con = null)
	{
		if ($this->aService === null && ($this->service_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aService->addWorkstationServices($this);
			 */
		}
