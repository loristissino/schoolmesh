...
abstract class BaseYearPeer {
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new YearMapBuilder();
		}
  ...
  static public function getUniqueColumnNames()
  {
	...
	public static function doValidate(Year $obj, $cols = null)
	{
		...
		$res =  BasePeer::doValidate(YearPeer::DATABASE_NAME, YearPeer::TABLE_NAME, $columns);
    if ($res !== true) {
        $request = sfContext::getInstance()->getRequest();
        foreach ($res as $failed) {
            $col = YearPeer::translateFieldname($failed->getColumn(), BasePeer::TYPE_COLNAME, BasePeer::TYPE_PHPNAME);
        }
    }
...
Propel::getDatabaseMap(BaseYearPeer::DATABASE_NAME)->addTableBuilder(BaseYearPeer::TABLE_NAME, BaseYearPeer::getMapBuilder());
