...
abstract class BaseProjectPeer {
	...
	const HOURS_APPROVED = 'project.HOURS_APPROVED';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'YearId', 'UserId', 'Title', 'Description', 'Notes', 'HoursApproved', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'yearId', 'userId', 'title', 'description', 'notes', 'hoursApproved', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::YEAR_ID, self::USER_ID, self::TITLE, self::DESCRIPTION, self::NOTES, self::HOURS_APPROVED, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'year_id', 'user_id', 'title', 'description', 'notes', 'hours_approved', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'YearId' => 1, 'UserId' => 2, 'Title' => 3, 'Description' => 4, 'Notes' => 5, 'HoursApproved' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'yearId' => 1, 'userId' => 2, 'title' => 3, 'description' => 4, 'notes' => 5, 'hoursApproved' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::YEAR_ID => 1, self::USER_ID => 2, self::TITLE => 3, self::DESCRIPTION => 4, self::NOTES => 5, self::HOURS_APPROVED => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'year_id' => 1, 'user_id' => 2, 'title' => 3, 'description' => 4, 'notes' => 5, 'hours_approved' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(ProjectPeer::HOURS_APPROVED);
	}
	 ...
	 */
	public static function addInstanceToPool(Project $obj, $key = null)
	{
	...
	public static function doCountJoinsfGuardUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(ProjectPeer::USER_ID, sfGuardUserPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Project objects pre-filled with their sfGuardUser objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of Project objects.
	...
	public static function doSelectJoinsfGuardUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Project) to $obj2 (sfGuardUser)
				$obj2->addProject($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (Project) to the collection in $obj3 (sfGuardUser)
	...
	public static function doSelectJoinAllExceptYear(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = ProjectPeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (Project) to the collection in $obj2 (sfGuardUser)
				$obj2->addProject($obj1);
	...
	/**
	 * Selects a collection of Project objects pre-filled with all related objects except sfGuardUser.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
