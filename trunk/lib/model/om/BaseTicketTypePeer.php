...
abstract class BaseTicketTypePeer {
	...
	const CLASS_DEFAULT = 'lib.model.TicketType';
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new TicketTypeMapBuilder();
		}
  ...
  static public function getUniqueColumnNames()
  {
	...
	{
		return TicketTypePeer::CLASS_DEFAULT;
	}
	...
	public static function doDeleteAll($con = null)
	{
	 ...
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
						...
						$criteria = clone $values;
		} elseif ($values instanceof TicketType) {
	...
	public static function doValidate(TicketType $obj, $cols = null)
	{
		...
		$res =  BasePeer::doValidate(TicketTypePeer::DATABASE_NAME, TicketTypePeer::TABLE_NAME, $columns);
    if ($res !== true) {
        $request = sfContext::getInstance()->getRequest();
        foreach ($res as $failed) {
            $col = TicketTypePeer::translateFieldname($failed->getColumn(), BasePeer::TYPE_COLNAME, BasePeer::TYPE_PHPNAME);
        }
    }
...
Propel::getDatabaseMap(BaseTicketTypePeer::DATABASE_NAME)->addTableBuilder(BaseTicketTypePeer::TABLE_NAME, BaseTicketTypePeer::getMapBuilder());
