...
abstract class BaseSchoolprojectForm extends BaseFormPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'teaching_body_approval_date'        => new sfWidgetFormDate(),
      'administration_board_approval_date' => new sfWidgetFormDate(),
    ));
    ...
    $this->setValidators(array(
      ...
      'teaching_body_approval_date'        => new sfValidatorDate(array('required' => false)),
      'administration_board_approval_date' => new sfValidatorDate(array('required' => false)),
    ));
