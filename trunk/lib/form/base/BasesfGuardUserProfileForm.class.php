...
class BasesfGuardUserProfileForm extends BaseFormPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'system_notes'                   => new sfWidgetFormInput(),
      'is_deleted'                     => new sfWidgetFormInputCheckbox(),
      'has_googleapps_account'         => new sfWidgetFormInputCheckbox(),
    ...
    $this->setValidators(array(
      ...
      'system_notes'                   => new sfValidatorString(array('max_length' => 255, 'required' => false)),
      'is_deleted'                     => new sfValidatorBoolean(array('required' => false)),
      'has_googleapps_account'         => new sfValidatorBoolean(array('required' => false)),
