...
abstract class BaseProjResourceFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'quantity_externally_funded' => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'quantity_externally_funded' => new sfValidatorSchemaFilter('text', new sfValidatorNumber(array('required' => false))),
  ...
  public function getFields()
  {
    return array(
      ...
      'quantity_externally_funded' => 'Number',
