...
class SentencePeer{
	...
	'users_bulk_upload_users_format'=>'type,first_name,middle_name,last_name,gender,birthdate,birthplace,email,import_code,group',
	'users_bulk_upload_users_example'=>"T,Francesco,Pietro,Genova,M,19651230,Valvasone(PN),francesco.genova@istruzione.it,GNVFRN,dipinfo\nO,Pasquale,,De Rolandis,M,,,DRLPSQ,\nS,Alice,,Alessandrini,F,,,LSSLCA,4AP\n...",
	
	'users_bulk_upload_appointments'=>'Upload a file in CSV format containing updated information about appointments.',
	'users_bulk_upload_appointments_format'=>'username,class,subject_id,year_id',
	'users_bulk_upload_appointments_example'=>"bruna.bagala,3AP,ING,2008_09\nmarco.defilippis,4AP,INF,2008_09\n...",
